...
| Aufgabe | Details |
| --- | --- |
| **Schritt 1: Aktualisieren von Adobe Analytics auf Customer Journey Analytics: Wählen Sie einen Aktualisierungspfad aus und senden Sie Daten an Adobe Experience Platform** | Beim Aktualisieren von Adobe Analytics auf Customer Journey Analytics stehen verschiedene Pfade zur Verfügung. Jeder mögliche Aktualisierungspfad hat seine eigenen Vor- und Nachteile, und ein Pfad, der für eine Organisation richtig ist, macht für eine andere Organisation möglicherweise keinen Sinn. <p>Informationen zum Starten der Aktualisierung von Adobe Analytics auf Customer Journey Analytics finden Sie unter [Erste Schritte mit dem Upgrade auf Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-getstarted.md). <!-- [Utilizing Adobe Analytics report suite data in Customer Journey Analytics](/help/getting-started/aa-vs-cja/aa-data-in-cja.md) --> </p> |
