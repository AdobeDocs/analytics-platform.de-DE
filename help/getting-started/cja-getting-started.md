...
| Aufgabe | Details |
| --- | --- |
| **Schritt 1: Wenn Sie von Adobe Analytics zu Customer Journey Analytics migrieren: Wählen Sie einen Migrationspfad und senden Sie Daten an Adobe Experience Platform** | Für die Migration von Adobe Analytics zu Customer Journey Analytics stehen verschiedene Pfade zur Verfügung. Jeder mögliche Migrationspfad hat seine eigenen Vor- und Nachteile, und ein Pfad, der für eine Organisation richtig ist, ist für eine andere Organisation möglicherweise nicht sinnvoll. <p>Informationen zum Starten der Migration von Adobe Analytics zu Customer Journey Analytics finden Sie unter [Erste Schritte mit der Migration zu Customer Journey Analytics](/help/getting-started/cja-migration/cja-migration-getstarted.md). <!-- [Utilizing Adobe Analytics report suite data in Customer Journey Analytics](/help/getting-started/aa-vs-cja/aa-data-in-cja.md) --> </p> |
