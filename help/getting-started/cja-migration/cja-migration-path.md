...
Der folgende Migrationspfad ist für Unternehmen verfügbar, die Adobe Analytics mit dem Experience Platform Web SDK implementiert haben.

Bei der Auswahl dieses Migrationspfads müssen Sie auch Ihr Schema auswählen.
...
Wenn Sie den Migrationspfad auswählen, über den Sie die Adobe Analytics Web SDK-Implementierung konfigurieren können, um Daten an Customer Journey Analytics zu senden, können Sie das Schema auswählen, das Sie verwenden möchten.
