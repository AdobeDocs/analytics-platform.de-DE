...
Nachdem Sie [den für Ihr ](/help/getting-started/cja-upgrade/cja-upgrade-path.md) optimalen Aktualisierungspfad ausgewählt haben, können Sie mit dem Senden von Daten an Adobe Experience Platform beginnen, um sie als Customer Journey Analytics verfügbar zu machen.
