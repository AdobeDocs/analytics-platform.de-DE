...
| BI-Erweiterung | Mit der BI-Erweiterung können Sie CJA direkt mit gängigen BI-Visualisierungs-Tools wie PowerBI oder Tableau verbinden, damit Ihre BI-Berichte genau mit den in Analysis Workspace und anderen CJA-Reporting-Oberflächen angezeigten Daten übereinstimmen. Dies ist eine wesentlich einfachere Möglichkeit, BI-Berichte für CJA zu erhalten, ohne dass Berichte/Metriken aus Rohdaten neu erstellt werden müssen. |
