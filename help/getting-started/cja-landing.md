...
Mit Customer Journey Analytics können Sie steuern, wie Sie Ihre Online- und Offline-Daten in Analysis Workspace mit einer beliebigen Kunden-ID verbinden. So können Sie Attribution, Segmente, Fluss, Fallout usw. für Ihre Kundendaten verwenden.
...
*Sie müssen mindestens über das Paket „Auswählen“ verfügen, um das Zusammenfügen zu aktivieren.*
...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>Aufnehmen und Verwenden von Daten</strong><br/> Erfahren Sie mehr über die Optionen, die Sie haben, um Daten in Experience Platform aufzunehmen und für Analysen und Berichte zu verwenden.</div>
    </td>
    <td>
    <a href="/help/guided-analysis/overview.md"><img src="./assets/product-analytics.png"></a>
    <div><strong>Geführte Analyse</strong><br/>Erfahren Sie, wie Sie mit Workflows Daten und Erkenntnisse über das Produkterlebnis von Kundschaft gewinnen können. Product Analytics durch geführte Analysen.
    </div>
    </td>
    <td>
    ...
    <div><strong>Content Analytics</strong><br/>Erfahren Sie, wie sich Inhalte neben dem Verhalten auf wichtige Leistungsindikatoren auswirken. Gewinnen Sie tiefere Einblicke in Kunden-Journey-Daten.</div>
    </td>
  </tr>
  <tr style="border: 0;">
...
<table style="table-layout:fixed">
  ...
  <tr style="border: 0;">
    ...
    <td>
      ...
      <strong>Und mehr…</strong><br/><a href="/help/guided-analysis/overview.md">Geführte Analyse</a> - <a href="/help/content-analytics/content-analytics.md">Content Analytics</a> - <a href="/help/getting-started/cja-b2b-edition.md">B2B edition</a> 
    </td>
  </tr>
</table>
...
<b>Bleiben Sie auf dem Laufenden, tragen Sie zur Community bei und gestalten Sie Ihr Customer Journey Analytics-Erlebnis</b><br>Besuchen Sie die Adobe Analytics-Community, um die Funktionalität mit Mitwirkenden zu besprechen. <a href="https://experienceleaguecommunities.adobe.com/t5/adobe-analytics/ct-p/adobe-analytics-community?profile.language=de">Werden Sie noch heute Teil der Community!</a></td></tr></tbody></table>
