...
* **Funktion als Headless BI-Lösung**: Sie definieren Ihre Dimensionen, Metriken und Filter an einem Ort. Daraufhin kann jeder Customer Journey Analytics-Client (einschließlich unserer öffentlichen Customer Journey Analytics-API) auf diese Komponenten zugreifen. Dadurch werden komplexe Abfragen von Endbenutzenden abstrahiert und es wird sichergestellt, dass die Ergebnisse unabhängig vom verwendeten Berichts- oder Visualisierungs-Client identisch sind.
