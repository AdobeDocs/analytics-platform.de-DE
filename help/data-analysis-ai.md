...
5. Wählen Sie oben rechts auf der Seite das Chat-Symbol für den KI-Assistenten aus.
   ...
   * **[!UICONTROL KI-Assistent: Datenanalyse]**
   ...
   Weitere Informationen erhalten Admins unter [diese Anweisungen](https://experienceleague.adobe.com/en/docs/analytics-platform/using/ai-assistant#feature-access).
