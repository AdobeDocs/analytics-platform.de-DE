...
>abstract="Erkennen und verwenden Sie auf jeder Ereignisebene automatisch einen identityMap **[!UICONTROL Namespace, der als]** definiert ist."
...
>abstract="Wählen Sie den Namespace aus, der zur Auswahl der Kennung im Identitätsdiagramm verwendet werden soll."
>additional-url="https://experienceleague.adobe.com/de/docs/analytics-platform/using/stitching/overview" text="Zuordnung – Überblick"
