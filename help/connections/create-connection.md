...
>title="Identitätszuordnung aktivieren"
>abstract="Aktivieren Sie Identitätszuordnung , um diesen Ereignis-Datensatz für die kanalübergreifende Analyse anzuheben."
>additional-url="https://experienceleague.adobe.com/de/docs/analytics-platform/using/stitching/overview" text="Übersicht über das Zusammenfügen"

>[!CONTEXTUALHELP]
>id="connection_stitching_dialog"
>title="Identitätszuordnung aktivieren"
>abstract="Identitätszuordnung aktivieren leitet eine zusammengefügte ID von einem einzelnen oder von mehreren Datensätzen ab. Dieser Prozess kann die Zusammenführung von Benutzerdaten aus authentifizierten und nicht authentifizierten Sitzungen beinhalten.<br/><br/>Sie sind dafür verantwortlich, die geltenden Gesetze und Vorschriften einzuhalten. Zu dieser Konformität gehört, dass Sie die erforderlichen Endbenutzerberechtigungen einholen, bevor Sie Datensätze zusammenführen."
>additional-url="https://experienceleague.adobe.com/de/docs/analytics-platform/using/stitching/overview" text="Übersicht über das Zusammenfügen"

>[!CONTEXTUALHELP]
>id="connection_persistent"
>title="Personen-ID"
>abstract="Wählen Sie eine persistente ID aus den verfügbaren Identitäten aus. Eine persistente ID ist eine Kennung, die für alle Ereignisse im Ereignisdatensatz verfügbar ist."
>additional-url="https://experienceleague.adobe.com/de/docs/analytics-platform/using/stitching/overview" text="Übersicht über das Zusammenfügen"

>[!CONTEXTUALHELP]
>id="connection_lookbackwindow"
>title="Lookback-Fenster"
>abstract="Wählen Sie den entsprechenden Zeitraum für das Lookback-Fenster aus, das beim Wiederholen des Stitching verwendet werden soll."
>additional-url="https://experienceleague.adobe.com/de/docs/analytics-platform/using/stitching/overview" text="Übersicht über das Zusammenfügen"
