...
>title="Persistente ID ändern"
>abstract="Bei einer Änderung der persistenten ID werden alle vorhandenen Daten in der Verbindung gelöscht und basierend auf der neuen persistenten ID werden alle Daten erneut aus dem Datensatz aufgenommen. Diese Aktion kann sich auf die Kosten auswirken. <br/><br/>Wenn Sie **[!UICONTROL Weiter]** wählen, kann es zu einer Verzögerung beim Reporting kommen, bis der Prozess abgeschlossen ist."
...
>abstract="Wählen Sie ein Feld aus, das mit einem der Ereignisdatensätze verknüpft werden soll. Wenn diese Liste leer ist, haben Sie wahrscheinlich keinen Ereignisdatensatz hinzugefügt oder konfiguriert."
...
>abstract="Vergewissern Sie sich, dass Sie die Einrichtung des Identitätsdiagramms abgeschlossen haben, bevor Sie das Identitätsdiagramm für die Zuordnung verwenden."
