...
>abstract="Das Ändern der Einstellung für die Identitätszuordnung in einem Datensatz wirkt sich auf die Einstellung der Personen-ID aus, sobald Sie die Änderungen anwenden. Eine Änderung der Personen-ID löscht alle vorhandenen Daten in der Verbindung. Sie müssen Daten aus dem Datensatz basierend auf der neuen Personen-ID erneut aufnehmen.<br/><br/>Wenn Sie **[!UICONTROL Weiter]** auswählen, ist eine Verzögerung beim Reporting möglich, bis der Löschvorgang abgeschlossen ist."
...
1. Konfigurieren Sie die Verbindungseinstellungen.
   ...
   | **[!UICONTROL Hinzufügen von Datensätzen]** | Wählen Sie ![Daten hinzufügen](/help/assets/icons/DataAdd.svg) **[!UICONTROL Datensätze hinzufügen]** aus, um [Datensätze hinzuzufügen](#add-datasets). Wenn die Verbindung noch keine Datensätze hat, können Sie auch in der Datensatztabelle **[!UICONTROL Datensätze hinzufügen]** auswählen. |
