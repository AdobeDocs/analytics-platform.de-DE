...
>abstract="Eine Änderung der Personen-ID löscht alle vorhandenen Daten in der Verbindung. Sie müssen Daten aus dem Datensatz basierend auf der neuen Personen-ID erneut aufnehmen.<br/><br/>Wenn Sie **[!UICONTROL Weiter]** auswählen, ist eine Verzögerung beim Reporting möglich, bis der Löschvorgang abgeschlossen ist."
