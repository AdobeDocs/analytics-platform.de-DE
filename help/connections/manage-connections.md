...
| **[!UICONTROL Typ des Datensatzes]** | Der [Datensatztyp](create-connection.md#dataset-types). Der Typ kann **[!UICONTROL Ereignis]**, **[!UICONTROL Profil]**, **[!UICONTROL Suche]**, **[!UICONTROL Zusammenfassung]** sein. Ein Ad-hoc- oder modellbasierter Datensatz wird durch **[!UICONTROL (Adhoc)]** oder **[!UICONTROL (Modell)]**. Zum Beispiel **[!UICONTROL Ereignis (Adhoc)]** oder **[!UICONTROL Lookup (Modell)]**. |
