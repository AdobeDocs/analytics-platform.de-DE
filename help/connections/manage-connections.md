...
description: Erfahren Sie, wie Sie Verbindungen zu Experience Platform-Datensätzen in Customer Journey Analytics (Customer Journey Analytics) verwalten.
mini-toc-levels: 3
...
Um einen Filter auf die Liste der Verbindungen anzuwenden, wählen Sie ![Filter](/help/assets/icons/Filter.svg) aus. Wählen Sie dann aus den folgenden Filteroptionen:
...
Wählen Sie ![Filter](/help/assets/icons/Filter.svg) **[!UICONTROL Filter ausblenden]** aus, um den Filterbereich auszublenden.
