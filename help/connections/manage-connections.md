...
| [!UICONTROL Importieren neuer Daten] | Zeigt den Status des Imports neuer Daten für den Datensatz an: <p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _on]**ob der Datensatz für den Import neuer Daten konfiguriert ist, und<p>![Status grau](assets/status-gray.svg)   **[!UICONTROL _x Aus_]** wenn der Datensatz so konfiguriert ist, dass er keinen neuen Datenimport importiert. |
| [!UICONTROL Daten transformieren] | Zeigt den Transformationsstatus der entsprechenden B2B-Lookup-Datensätze an. Weitere Informationen finden Sie unter [Umwandeln von Datensätzen für B2B-Suchen](transform-datasets-b2b-lookups.md).<p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _on]**für relevante Datensätze, die für die Umwandlung aktiviert sind, <p>![Status grau](assets/status-gray.svg)   **[!UICONTROL _x Aus_]** für anwendbare Datensätze, die nicht für die Transformation aktiviert sind, und<p>**[!UICONTROL Nicht zutreffend]** für alle anderen Datensätze, die nicht für die Umwandlung gelten. |
| [!UICONTROL Aufstockungsdaten] | Zeigt den Status der Aufstockungsdaten für den Datensatz an.<p>![Status rot](assets/status-red.svg)   **[!UICONTROL _x _Aufstockungen fehlgeschlagen]**für die Anzahl fehlgeschlagener Aufstockungen,<p>![Status rot](assets/status-orange.svg)   **[!UICONTROL _x _Verarbeitung von Backfilets]**für die Anzahl der Aufstockungen,<p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _Aufstockungen abgeschlossen]**für die Anzahl der abgeschlossenen Aufstockungen und<p>![Status grau](assets/status-gray.svg)   **[!UICONTROL _Aus_]** , falls keine Aufstockungen konfiguriert sind. |
| [!UICONTROL Importieren neuer Daten] | Zeigt den Status des Imports neuer Daten für den Datensatz an: <p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _on]**ob der Datensatz für den Import neuer Daten konfiguriert ist, und<p>![Status grau](assets/status-gray.svg)   **[!UICONTROL _x Aus_]** wenn der Datensatz so konfiguriert ist, dass er keine neuen Daten importiert. |
| [!UICONTROL Aufstockungsdaten] | Zeigt den Status der Aufstockungsdaten für den Datensatz an.<p>![Status rot](assets/status-red.svg)   **[!UICONTROL _x _Aufstockungen fehlgeschlagen]**für die Anzahl fehlgeschlagener Aufstockungen,<p>![Status rot](assets/status-orange.svg)   **[!UICONTROL _x _Verarbeitung von Backfilets]**für die Anzahl der Aufstockungen,<p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _Aufstockungen abgeschlossen]**für die Anzahl der abgeschlossenen Aufstockungen und<p>![Status grau](assets/status-gray.svg)   **[!UICONTROL _Aus_]** , falls keine Aufstockungen konfiguriert sind. |
...
| [!UICONTROL Neue Daten importieren] | Zeigt den Status des Imports neuer Daten für Datensätze an: <p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _on]**für die Anzahl der Datensätze, die für den Import neuer Daten konfiguriert sind, und<p>![Status grau](assets/status-gray.svg)   **[!UICONTROL _x Aus_]** für die Anzahl der Datensätze, für die der neue Datenimport deaktiviert ist. |
| [!UICONTROL Aufstockungsdaten] | Zeigt den Status der Aufstockungsdaten für Datensätze an.<p>![Status rot](assets/status-red.svg)   **[!UICONTROL _x _Aufstockungen fehlgeschlagen]**für die Anzahl fehlgeschlagener Aufstockungen in Datensätzen,<p>![Status rot](assets/status-orange.svg)   **[!UICONTROL _x _Verarbeitung von Backfilets]**für die Anzahl der Aufstockungen für die Verarbeitung in Datensätzen,<p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _Aufstockungen abgeschlossen]**für die Anzahl abgeschlossener Backups für Datensätze und<p>![Status grau](assets/status-gray.svg)   **[!UICONTROL _Aus_]** , falls für die Datensätze in der Verbindung keine Rückfüllungen definiert sind. |
| Daten transformieren | Zeigt den Transformationsstatus der entsprechenden B2B-Lookup-Datensätze an. Weitere Informationen finden Sie unter [Umwandeln von Datensätzen für B2B-Suchen](transform-datasets-b2b-lookups.md).<p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _on]**für die Anzahl der Datensätze, die für die Transformation aktiviert sind. |
...
| [!UICONTROL Importieren neuer Daten] | Zeigt den Status des Imports neuer Daten für den Datensatz an: <p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _on]**ob der Datensatz für den Import neuer Daten konfiguriert ist, und<p>![Status grau](assets/status-gray.svg)   **[!UICONTROL _x Aus_]** wenn der Datensatz so konfiguriert ist, dass er keine neuen Daten importiert. |
| [!UICONTROL Aufstockungsdaten] | Zeigt den Status der Aufstockungsdaten für den Datensatz an.<p>![Status rot](assets/status-red.svg)   **[!UICONTROL _x _Aufstockungen fehlgeschlagen]**für die Anzahl fehlgeschlagener Aufstockungen,<p>![Status rot](assets/status-orange.svg)   **[!UICONTROL _x _Verarbeitung von Backfilets]**für die Anzahl der Aufstockungen,<p>![Status Grün](assets/status-green.svg)   **[!UICONTROL _x _Aufstockungen abgeschlossen]**für die Anzahl der abgeschlossenen Aufstockungen und<p>![Status grau](assets/status-gray.svg)   **[!UICONTROL _Aus_]** , falls keine Aufstockungen konfiguriert sind.<p>Um ein Dialogfeld mit einem Überblick über die früheren Rückstände für den Datensatz anzuzeigen, wählen Sie <img src="./assets/pastbackfill.svg" alt="Frühere Aufstockungen" width="15"/> **[!UICONTROL Frühere Backfilets]**. |
...
* In einem Bedienfeld werden die insgesamt erfassten Zeilen angezeigt, die alle Ereignisdaten für alle Verbindungen enthalten, die an jedem zweiten Tag eines Monats aktualisiert wurden. Innerhalb des Bedienfelds:
   ...
   * Ein Liniendiagramm zeigt die ◼︎ an [!UICONTROL Monatlich aufgenommene Zeilen].<br/>Um ein Popup anzuzeigen, das die Anzahl der monatlich erfassten Zeilen für einen Monat anzeigt, bewegen Sie den Mauszeiger über einen Datenpunkt im Liniendiagramm.
...
* In einem Bedienfeld werden alle berichtspflichtigen Zeilen angezeigt, die alle Ereignisdaten für alle Verbindungen enthalten, die an jedem zweiten Tag eines Monats aktualisiert wurden. Innerhalb des Bedienfelds:
   ...
   * Ein Liniendiagramm zeigt die ◼︎ an [!UICONTROL Berichtspflichtige Zeilen pro Monat].<br/>Um ein Popup anzuzeigen, das die Anzahl der kumulativen berichtbaren Zeilen für einen bestimmten Monat anzeigt, bewegen Sie den Mauszeiger über einen Datenpunkt im Liniendiagramm.
   * Ein Liniendiagramm zeigt die ◼︎ an [!UICONTROL Zusammenfassende berichtspflichtige Zeilen].<br/>Um ein Popup anzuzeigen, das die Anzahl der monatlich berichteten Zeilen für einen Monat anzeigt, bewegen Sie den Mauszeiger über einen Datenpunkt im Liniendiagramm.
