...
| [!UICONTROL Importieren neuer Daten] | Zeigt den Status des Imports neuer Daten für Datensätze an: <p><span style="color:green">●</span>   **[!UICONTROL _x _on]**für Datensätze, die zum Importieren neuer Daten konfiguriert sind, und<p><span style="color:gray">●</span>   **[!UICONTROL _x Aus_]** für Datensätze, die nicht für den Import neuer Daten konfiguriert sind. |
...
| [!UICONTROL Daten transformieren] | Zeigt den Transformationsstatus der entsprechenden B2B-Lookup-Datensätze an. Siehe [Datensätze für B2B-Suchen transformieren](transform-datasets-b2b-lookups.md) für weitere Informationen.<p><span style="color:green">●</span>   **[!UICONTROL _x _on]**für relevante Datensätze, die für die Umwandlung aktiviert sind, <p><span style="color:gray">●</span>   **[!UICONTROL _x Aus_]** für anwendbare Datensätze, die nicht für die Transformation aktiviert sind, und<p>**[!UICONTROL Nicht zutreffend]** für alle anderen Datensätze, die nicht für die Umwandlung gelten. |
...
| Daten transformieren | Zeigt den Transformationsstatus der entsprechenden B2B-Lookup-Datensätze an. Siehe [Datensätze für B2B-Suchen transformieren](transform-datasets-b2b-lookups.md) für weitere Informationen.<p><span style="color:green">●</span>   **[!UICONTROL _x _on]**für die Anzahl der Datensätze, die für die Transformation aktiviert sind. |
