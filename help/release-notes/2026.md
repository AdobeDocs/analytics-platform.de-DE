...
| Funktion und Beschreibung | [Rollout-Beginn](releases.md) | [Allgemeine Verfügbarkeit](releases.md) |
| -----------|-----------|-----------|
| **Markensichtbarkeit-Integration**<br> Die [Markensichtbarkeit-Eingangsintegration](/help/integrations/bv.md#inbound-integration) ermöglicht es Ihnen, Markensichtbarkeit-Daten zur weiteren Analyse in Customer Journey Analytics aufzunehmen. | | &#x200B;28. Juli 2026 |
