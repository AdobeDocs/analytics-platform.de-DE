...
| ----------- | ---------- | ------- | ---- |
| **Aktualisierungen der Benutzeroberfläche von** | Die [Nutzungsschnittstelle](/help/connections/manage-connections.md#usage) fügt jetzt Informationen zum Kerndatenvolumen und zur durchschnittlichen Zeilengröße hinzu.<p>Weitere Informationen finden Sie unter [Verbindungen verwalten](/help/connections/manage-connections.md#usage).</p> | | Freitag, 4. September 2025 |
