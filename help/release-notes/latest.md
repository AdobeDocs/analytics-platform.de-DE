...
| **MCP-Server für Customer Journey Analytics** <br/>Sie können Customer Journey Analytics jetzt mithilfe von MCP (Model Context Protocol) in Ihre bestehenden Agent-basierten Workflows einbinden. Sie können Berichte und Erkenntnisse in natürlicher Sprache anfordern.<p>(Link zur Dokumentation folgt.)</p> | | Ende April 2026 |
