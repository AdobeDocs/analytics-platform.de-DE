...
| -----------|-----------|-----------|
| **Analyse** Unterereignissen<br/> ermöglicht die Analyse von Daten auf einer detaillierteren Ebene als auf Ereignisebene. Anstatt nach ganzen Ereignissen zu filtern, können Sie innerhalb eines Ereignisses nach einzelnen Containern segmentieren. <p>Sie können beispielsweise eine Segmentierung für eine bestimmte Produktkategorie durchführen, ohne alle anderen in derselben Bestellung gekauften Produkte einzubeziehen. Sie können auch Objekte oder Arrays, die Teil Ihrer Ereignisdaten sind, als separate Container in einer Datenansicht definieren.</p> | &#x200B;8. Juli | Ende Juli 2026 |
| **CJA B2B: Unterstützung für Ad-hoc- und** Datensätze: <br/>Ad-hoc- und relationale Datensätze werden jetzt auch in CJA B2B-Kontoverbindungen unterstützt.<p>(Link zur Dokumentation folgt.)</p> | | &#x200B;20. Juli 2026 |
| **Paid-Media** Daten<br/>Bezahlte Medien werden als dritter Kanal für Content Analytics hinzugefügt.<p>(Link zur Dokumentation folgt.)</p> | | &#x200B;31. Juli 2026 |
| **Aktualisierung der**-Benutzeroberfläche<br/>Sie können Nutzungsdetails für jedes einzelne Modul anzeigen, z. B. Customer Journey Analytics oder Customer Journey Analytics B2B edition. Darüber hinaus können Sie die Berichte zur Nutzung für jedes Modul nach Monat aufschlüsseln.<p>(Link zur Dokumentation folgt.)</p> | | &#x200B;31. Juli 2026 |
| **CX Enterprise Coworker: Überprüfen Sie Ihre Daten bei der Migration von Adobe Analytics zu Customer Journey Analytics** <br/>Mit einer neuen Fähigkeit in CX Enterprise Coworker können Sie die Daten aus Ihrer Customer Journey Analytics-Implementierung mit den Daten aus Ihrer bestehenden Adobe Analytics-Implementierung vergleichen. <p>Diese Qualifikation vergleicht automatisch jede Dimension, jede Metrik und jeden Trend und generiert dann KI-gesteuerte Einblicke und Empfehlungen, die Sie implementieren können, um Ihre Migration zu Customer Journey Analytics zu erleichtern.</p><p>(Link zur Dokumentation folgt.)</p> | | Ende Juli 2026 |
