...
| ----------- | ---------- | ------- | ---- |
| **Dimension „Ereignistiefe“** | Eine neue Dimension Ereignistiefe wird zur Liste der [erforderlichen Standardkomponenten](/help/data-views/component-reference.md#required-standard-components) für eine Datenansicht hinzugefügt. |  | Freitag, 8. Mai 2025 |
