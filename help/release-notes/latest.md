...
| **Auswählen mehrerer Filter, wenn sie im Dropdown-Menü in einer Freiformtabelle verfügbar sind** | Wenn einer Freiformtabelle als Dropdown-Menü mehrere Filter hinzugefügt wurden, können Benutzer der Freiformtabelle jetzt mehrere Filter gleichzeitig auswählen. Die Freiformtabelle wird gefiltert, um einen der ausgewählten Filter einzuschließen. <p>Zuvor konnten Benutzer in einem Dropdown-Menü für Filter jeweils nur einen Filter auswählen.</p><p>(Der Dokumentationslink folgt.)<!--For more information, see "Add filters to a project" in "Use components in Analysis Workspace."--> |  | Donnerstag, 19. Juni 2024 |
