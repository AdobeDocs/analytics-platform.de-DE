...
* Es wurden Customer Journey Analytics-Leistungsprobleme behoben (Fehlermeldungen beim Laden von Projekten). (AN-269451, AN-270649)
* Es wurde ein Problem auf Customer Journey Analytics behoben, bei dem die Sitzungsstarts nicht mit den Flusseinträgen für Seitennamen übereinstimmten. (AN-273501)
* Es wurde ein Problem behoben, durch das der Fallout-Bericht in Customer Journey Analytics nicht ordnungsgemäß funktionierte. (AN-269761)

## Oktober 2021 {#1021}

| Funktion | Beschreibung | [Allgemeine Verfügbarkeit](https://experienceleague.adobe.com/docs/analytics/technotes/releases.html?lang=de) – geplantes Datum |
| ----------- | ---------- | ----- |
| Rollierendes Fenster für die Datenaufbewahrung auf [!UICONTROL Verbindungsebene] | **Hinweis: Wenden Sie sich an die Kundenunterstützung oder Ihr Adobe-Account-Team, um diese Einstellung implementieren zu lassen. Sie ist noch nicht über die Customer Journey Analytics-Benutzeroberfläche verfügbar.**<p>Ermöglicht die Definition einer Customer Journey Analytics-Datenbeibehaltungseinstellung als rollierendes Fenster in Monaten (3 Monate, 6 Monate usw.) auf einer [!UICONTROL Verbindungs]-Ebene (nicht auf einer [!UICONTROL Datensatz]-Ebene). Die Datenaufbewahrung basiert auf Zeitstempeln für Ereignis-Datensätze und gilt nur für Ereignis-Datensätze. Für Profil- oder Lookup-Datensätze gibt es keine Datenaufbewahrungseinstellung, da keine entsprechenden Zeitstempel vorhanden sind. Der Hauptvorteil besteht darin, dass Sie nur Daten speichern oder Berichte dazu erstellen, die anwendbar und nützlich sind, und ältere Daten löschen, die nicht mehr nützlich sind. Dies hilft Ihnen, Ihre vertraglichen Beschränkungen einzuhalten und das Risiko bezüglich Kostendeckung zu reduzieren. | 7. Oktober 2021 |
...
| Funktion | [Allgemeine Verfügbarkeit](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html?lang=de) – geplantes Datum | Beschreibung |
| ----------- | ---------- | ----- |
| Unterstützung für [!UICONTROL Adobe Analytics-Dashboards] | 25. März 2021 | [!UICONTROL Customer Journey Analytics] unterstützt jetzt den [!UICONTROL Scorecard-Builder für Adobe Analytics-Dashboards] und die Mobile App. Auf diese Weise können Führungskräfte und Geschäftsanwender ihre kanalübergreifenden KPIs basierend auf Customer Journey Analytics-Daten mit derselben App anzeigen, die sie möglicherweise bereits für Adobe Analytics verwenden. |
...
| Customer Journey Analytics-API | 18. Februar 2021 | Die Customer Journey Analytics-APIs sind jetzt verfügbar. Mit diesen APIs können Sie programmgesteuert Komponenten bearbeiten und Berichte abrufen. Weitere Informationen finden Sie in der Dokumentation zur [Customer Journey Analytics](https://www.adobe.io/cja-apis/docs)API . |
