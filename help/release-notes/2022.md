...
| **Customer Journey Analytics-Unterstützung für Data-Governance-Labels und -Richtlinien**. | Automatisiert die Integration zwischen Customer Journey Analytics- und Adobe Experience Platform-Datenschutz-Labels und -richtlinien. Daten-Labels, die für von Platform verwendete Datensätze erstellt wurden, werden in Customer Journey Analytics-Datenansichten angezeigt, um Benutzende zu stoppen oder zu warnen, die Metriken und/oder Dimensionen aus sensiblen Feldern erstellen. Außerdem, wenn Daten aus Customer Journey Analytics exportiert werden (über Workspace oder Report Builder, Reporting, Export, API usw.) Es werden zusätzliche Warnhinweise oder Beschriftungen hinzugefügt, um Benutzende darüber zu informieren, dass ein Bericht sensible Informationen enthält, die auf bestimmte Weise behandelt werden müssen. [Weitere Informationen](/help/data-views/data-governance.md) | &#x200B;14. September 2022 |
...
* Es wurde ein Konsolenfehler beim Zugriff auf Customer Journey Analytics über die CX Enterprise-Homepage behoben. (AN-281468)
