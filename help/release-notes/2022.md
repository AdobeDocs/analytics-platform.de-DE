...
| **Variablen mit mehreren Werten, bei denen nicht zwischen Groß- und Kleinschreibung unterschieden wird** | Bei Variablen mit mehreren Werten, bei denen nicht zwischen Groß- und Kleinschreibung unterschieden wird, werden die in `mvvar1` - `mvvar3` gespeicherten Werte nicht mehr automatisch in Kleinbuchstaben geschrieben. Stattdessen spiegeln Daten, die über den Analytics-Quell-Connector an Adobe Experience Platform und Customer Journey Analytics übergeben werden, die Originalschreibweise wider, die von der Seite weitergegeben wurde. Spalten für Quell-Connector und Customer Journey Analytics `_experience.analytics.customDimensions.lists.list1.list[]` - `_experience.analytics.customDimensions.lists.list3.list[]` von dieser Änderung betroffen sind. | Nicht angegeben | 24. Oktober 2022 |
| **Customer Journey Analytics-Auditprotokoll** | Mit Customer Journey Analytics können Sie die Benutzeraktivität auf verschiedene Dienste und Funktionen in Form von &quot;Auditprotokollen&quot;überprüfen. Diese Protokolle bilden einen Prüfpfad, der Ihnen bei der Fehlerbehebung helfen kann und Ihrem Unternehmen ermöglicht, betriebliche Datenverwaltungsrichtlinien und gesetzliche Anforderungen wie den Health Insurance Portability and Accountability Act (HIPAA) einzuhalten. Diese Protokolle waren bisher nur über die Auditprotokolle-API verfügbar. [Weitere Informationen](/help/privacy/audit-log.md) | Nicht angegeben | 26. Oktober 2022 |
| **HIPAA-Bereitschaft** | Adobe unterstützt jetzt das Empfangen, Verwenden, Verwalten oder Senden geschützter Gesundheitsinformationen in Customer Journey Analytics und anderen Experience Platform-basierten Anwendungen für [!DNL Healthcare Shield] nur für Kunden. [!DNL Healthcare Shield] ist nur für Kunden im Gesundheitswesen bestimmt, die entweder eine abgedeckte Organisation oder einen Business Associate in den USA sind. [Weitere Informationen](https://www.adobe.com/trust/compliance/hipaa-ready.html) | Nicht angegeben | 7. November 2022 |
...
| **Experimentier-Bedienfeld** | Mit diesem neuen Arbeitsbereich-Bedienfeld können Customer Journey Analytics-Benutzer die Steigerung und Konfidenz von A/B-Experimenten aus jeder beliebigen Quelle bewerten - online, offline, aus Adobe-Lösungen, Adobe Journey Optimizer und sogar BYO-Daten. [Weitere Informationen](/help/analysis-workspace/c-panels/experimentation.md) | 5. Oktober 2022 |
...
| **Unterstützung von Datumsfeldern in Customer Journey Analytics** | Ermöglicht Customer Journey Analytics die Berichterstellung über Datums- und Uhrzeitfelder. [Weitere Informationen](/help/use-cases/data-views/data-views-usecases.md) | 5. Oktober 2022 |
...
| **Variablen mit mehreren Werten, bei denen nicht zwischen Groß- und Kleinschreibung unterschieden wird** | Bei Variablen mit mehreren Werten, bei denen nicht zwischen Groß- und Kleinschreibung unterschieden wird, werden die in `mvvar1` - `mvvar3` gespeicherten Werte nicht mehr automatisch in Kleinbuchstaben geschrieben. Stattdessen spiegeln Daten, die über den Analytics-Quell-Connector an Adobe Experience Platform und Customer Journey Analytics übergeben werden, die Originalschreibweise wider, die von der Seite weitergegeben wurde. | 24. Oktober 2022 |
...
| **Experimentierbereich für Customer Journey Analytics** | Mit diesem neuen Arbeitsbereich-Bedienfeld können Customer Journey Analytics-Benutzer die Steigerung und Konfidenz von A/B-Experimenten aus jeder beliebigen Quelle bewerten - online, offline, aus Adobe-Lösungen, Adobe Journey Optimizer und sogar aus BYO-Daten (eigene Daten mitbringen). [Weitere Informationen](/help/analysis-workspace/c-panels/experimentation.md) | [Eingeschränkte Veröffentlichung](/help/release-notes/releases.md) ab 14. September 2022 |
...
| **Customer Journey Analytics-Unterstützung für Data Governance-Beschriftungen und -Richtlinien** | Automatisiert die Integration zwischen Datenschutzbezeichnungen und -richtlinien von Customer Journey Analytics und Adobe Experience Platform. Datenbezeichnungen, die in von Platform verwendeten Datensätzen erstellt wurden, werden in Customer Journey Analytics-Datenansichten angezeigt, um Benutzer, die Metriken und/oder Dimensionen aus sensiblen Feldern erstellen, anzuhalten oder zu warnen. Außerdem, wenn Daten aus Customer Journey Analytics exportiert werden (über Workspace oder Report Builder Reporting, Export, API usw.) werden zusätzliche Warnungen oder Kennzeichnungen hinzugefügt, um die Nutzer darauf hinzuweisen, dass ein Bericht sensible Informationen enthält, die auf eine bestimmte Weise behandelt werden müssen. [Weitere Informationen](/help/data-views/data-governance.md) | 14. September 2022 |
...
| Zielgruppenveröffentlichung im Echtzeit-Kundenprofil | Ermöglicht die Veröffentlichung von Zielgruppen, die im Customer Journey Analytics in Adobe Experience Platform/Echtzeit-Kundenprofil entdeckt werden, um Kunden-Targeting und Personalisierung zu ermöglichen. [Weitere Informationen](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/audiences-overview.html?lang=de) | 17. August 2022 |
| Regionsübergreifende Unterstützung für Analytics-Quell-Connector | Sie können jetzt Berichts-Suites aus jeder Region (Vereinigte Staaten, Vereinigtes Königreich oder Singapur) einlesen. Diese Berichts-Suites müssen jedoch derselben Organisation zugeordnet sein wie die Experience Platform-Sandbox-Instanz, in der die Source-Verbindung erstellt wird. [Weitere Informationen](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics.html?lang=de) | 24. August 2022 |
| Erste Sitzungsberichte | Sie können jetzt feststellen, ob es sich bei einer bestimmten Sitzung um die allererste Sitzung einer Person handelte. [Weitere Informationen](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html#new-repeat) | 24. August 2022 |
...
| Analytics-Labs in Customer Journey Analytics | Unterstützen Sie Labs in Customer Journey Analytics, damit Sie Prototypen mit kanalübergreifenden Daten untersuchen können. [Weitere Informationen](/help/labs/labs.md) | 15. Juni 2022 |
...
| Report Builder für Customer Journey Analytics-Updates | Enthält Funktionen wie Planung und Datenblock-Manager. [Weitere Informationen](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/manage-reportbuilder.html?lang=de) | 18. Mai 2022 |
...
| Datenvorbereitung für Analytics-Quell-Connector | Die [Analytics-Quell-Connector](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics.html?lang=de) ist jetzt in die [Datenvorbereitung](https://experienceleague.adobe.com/docs/experience-platform/data-prep/home.html?lang=de) Funktionen von Adobe Experience Platform. Kunden von Adobe Real-time Customer Data Platform (RTCDP), Customer Journey Analytics und Adobe Journey Optimizer können jetzt die Analytics-Feldergruppe um zusätzliche Feldergruppen erweitern. Sie können außerdem 100+ Data Prep-Operatoren nutzen, um die Analytics-Daten während der Aufnahme in Adobe Experience Platform anzureichern. RTCDP-Kunden können jetzt mehrere Data Prep-fähige Report Suites für ein Profil aktivieren.<p>Customer Journey Analytics-Kunden, die mehrere Report Suites über den Analytics-Quell-Connector erfassen, haben jetzt die Möglichkeit, Spaltenunterschiede zwischen Report Suites abzubauen. Wenn beispielsweise „Suchbegriff“ in `eVar1` in einer Report Suite und in `eVar2` in einer anderen Report Suite gespeichert ist, können Sie mithilfe von Data Prep die Analytics-Feldergruppe um eine neue Spalte erweitern, in der die Werte aus den beiden eVars zusammengeführt werden. | 27. April 2022 |
...
* Es wurde ein Konsolenfehler beim Zugriff auf Customer Journey Analytics über die Experience Cloud-Homepage behoben. (AN-281468)
