...
| **Experimentier-Bedienfeld** | Mit diesem neuen Workspace-Bedienfeld können Customer Journey Analytics-Anwender den Anstieg und die Konfidenz von A/B-Experimenten bewerten, die aus beliebigen Quellen stammen - online, offline, Adobe-Lösungen, Adobe Journey Optimizer und sogar BYO-Daten. [Weitere Informationen](/help/analysis-workspace/c-panels/experimentation.md) | 5. Oktober 2022 |
...
| **Unterstützung von Datumsfeldern auf Customer Journey Analytics** | Ermöglicht dem Customer Journey Analytics, Berichte zu Datums- und Uhrzeitfeldern zu erstellen. [Weitere Informationen](/help/use-cases/data-views/data-views-usecases.md) | 5. Oktober 2022 |
...
| **Experimentier-Bedienfeld zum Customer Journey Analytics** | Mit diesem neuen Workspace-Bedienfeld können Customer Journey Analytics-Anwender den Anstieg und die Konfidenz von A/B-Experimenten bewerten, die aus beliebigen Quellen stammen - online, offline, aus Adobe-Lösungen, Adobe Journey Optimizer und sogar BYO-Daten (bring-your-own). [Weitere Informationen](/help/analysis-workspace/c-panels/experimentation.md) | [Eingeschränkte Veröffentlichung](/help/release-notes/releases.md) ab 14. September 2022 |
...
| Zielgruppenveröffentlichung im Echtzeit-Kundenprofil | Ermöglicht die Veröffentlichung von Zielgruppen, die beim Customer Journey Analytics gefunden wurden, im Adobe Experience Platform-/Echtzeit-Kundenprofil zur Zielgruppenbestimmung und Personalisierung. [Weitere Informationen](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/audiences-overview.html?lang=de) | 17. August 2022 |
| Regionenübergreifende Unterstützung für Analytics Source Connector | Sie können jetzt Berichts-Suites aus jeder Region (Vereinigte Staaten, Vereinigtes Königreich oder Singapur) einlesen. Diese Berichts-Suites müssen jedoch derselben Organisation zugeordnet sein wie die Experience Platform-Sandbox-Instanz, in der die Source-Verbindung erstellt wird. [Weitere Informationen](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics.html?lang=de) | 24. August 2022 |
...
| Analytics-Labs in Customer Journey Analytics | Unterstützen Sie Labs beim Customer Journey Analytics, damit Sie Prototypen mit kanalübergreifenden Daten untersuchen können. [Weitere Informationen](/help/labs/labs.md) | 15. Juni 2022 |
...
| Datenvorbereitung für den Analytics-Quell-Connector | Der [Analytics-Quell](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics.html?lang=de)Connector ist jetzt in die [Datenvorbereitung](https://experienceleague.adobe.com/docs/experience-platform/data-prep/home.html?lang=de) von Adobe Experience Platform integriert. Kunden von Adobe Real-time Customer Data Platform (RTCDP), Customer Journey Analytics und Adobe Journey Optimizer können die Analytics-Feldergruppe jetzt um zusätzliche Feldergruppen erweitern. Sie können auch über 100 Data Prep-Operatoren nutzen, um die Analytics-Daten während der Aufnahme in Adobe Experience Platform anzureichern. RTCDP-Kunden können jetzt mehrere Data Prep-fähige Report Suites für ein Profil aktivieren.<p>Customer Journey Analytics-Kunden, die mehrere Report Suites über den Analytics-Quell-Connector aufnehmen, können jetzt Spaltenunterschiede zwischen Report Suites beheben. Wenn beispielsweise „Suchbegriff“ in `eVar1` in einer Report Suite und in `eVar2` in einer anderen Report Suite gespeichert ist, können Sie mithilfe von Data Prep die Analytics-Feldergruppe um eine neue Spalte erweitern, in der die Werte aus den beiden eVars zusammengeführt werden. | 27. April 2022 |
...
* Es wurde ein Konsolenfehler beim Zugriff auf Customer Journey Analytics von der Experience Cloud-Homepage behoben. (AN-281468)
