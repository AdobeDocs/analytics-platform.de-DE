...
| **HIPAA-Bereitschaft** | Adobe unterstützt jetzt nur noch den Empfang, die Verwendung, die Pflege oder die Übertragung von geschützten Gesundheitsinformationen in Customer Journey Analytics und anderen Experience Platform-basierten Anwendungen für [!DNL Healthcare Shield] -Kunden. [!DNL Healthcare Shield] ist nur für Kunden im Gesundheitswesen bestimmt, die entweder eine abgedeckte Entität oder einen Business Associate in den USA sind. [Weitere Informationen](https://www.adobe.com/trust/compliance/hipaa-ready.html) | Nicht angegeben | 7. November 2022 |
...
| **Datumsfeldunterstützung in Customer Journey Analytics** | Ermöglicht Customer Journey Analytics die Berichterstellung über Datums- und Uhrzeitfelder. [Weitere Informationen](/help/use-cases/data-views/data-views-usecases.md) | 5. Oktober 2022 |
...
| **Experimentierbereich für Customer Journey Analytics** | Mit diesem neuen Workspace-Bedienfeld können Customer Journey Analytics-Anwender die Steigerung und Konfidenz von A/B-Experimenten aus jeder beliebigen Quelle bewerten - online, offline, aus Adobe-Lösungen, Adobe Journey Optimizer und sogar BYO-Daten (auch &quot;Hoch- und Ohr&quot;-Daten). [Weitere Informationen](/help/analysis-workspace/c-panels/experimentation.md) | [Eingeschränkte Veröffentlichung](/help/release-notes/releases.md) ab 14. September 2022 |
