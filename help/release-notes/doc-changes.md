...
| Zusätzliche Informationen in der Spalte „Wird verwendet in“ im Manager für berechnete Metriken und im Segment-Manager | Die Spalte „Verwendet in“ im [Manager für berechnete Metriken](https://experienceleague.adobe.com/de/docs/analytics-platform/using/cja-components/cja-calcmetrics/cm-workflow/cm-manager?lang=de) und im [Filter-Manager](https://experienceleague.adobe.com/de/docs/analytics-platform/using/cja-components/cja-filters/manage-filters?lang=de) enthält die folgenden neuen Reporting-Bereiche: Report Builder und Ad-hoc-Komponenten. |
| **August 2024** | |
