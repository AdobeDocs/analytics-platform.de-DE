...
| --- | --- |
| **April 2025** | |
| Anzeigen und Verwalten der Nutzung | Die Dokumentation zur Verwendung von [ (Anzeigen](/help/connections/manage-connections.md#usage) und [) ](/help/technotes/estimate-usage.md) Customer Journey Analytics wurde überarbeitet |
| Inhaltsanalyse | [Dokumentation](/help/content-analytics/content-analytics.md) für Adobe Content Analytics. Mit Content Analytics können Sie schnell und einfach große Mengen von Inhaltsdaten untersuchen, um Trends aufzudecken, Anomalien zu erkennen, die Ermüdung von Inhalten zu identifizieren und Erkenntnisse aus der Offenlegung von Inhalten zu gewinnen. |
| **März 2025** | |
...
| Asset-Übertragung | Ermöglicht die [Übertragung der Verantwortung](https://experienceleague.adobe.com/de/docs/analytics-platform/using/tools/asset-transfer/transfer-assets) von Komponenten wie Projekten, Segmenten und berechneten Metriken an andere Benutzer, um Kontinuität und angemessenen Zugriff sicherzustellen. |
...
| Workspace und Komponenten | Die Dokumentation zu Analysis Workspace-Projekten (Projekte, Visualisierungen und Bedienfelder) und -Komponenten (Anmerkungen, Dimensionen, (berechnete) Metriken, Segmente, Datumsbereiche, Warnhinweise, geplante Projekte und Zielgruppen) wurde aktualisiert. |
...
| Zusätzliche Informationen in der Spalte „Wird verwendet in“ im Manager für berechnete Metriken und im Segment-Manager | Die Spalte „Verwendet in“ in den [Manager für berechnete Metriken](https://experienceleague.adobe.com/de/docs/analytics-platform/using/cja-components/cja-calcmetrics/cm-workflow/cm-manager?lang=de) und [Segmentmanager](https://experienceleague.adobe.com/de/docs/analytics-platform/using/cja-components/cja-filters/manage-filters?lang=de) enthält die folgenden neuen Berichtsbereiche: Report Builder und Ad-hoc-Komponenten |
| **August 2024** | |
...
| Es wurde eine Dokumentation zur Erweiterung der Berechtigungen für projektspezifische Workspace-Komponenten hinzugefügt | Wenn Sie ein Projekt für andere Benutzer freigeben, können diese Benutzer [Schnellsegmente](/help/components/filters/quick-filters.md) und andere Projektkomponenten bearbeiten, die in das freigegebene Projekt eingebettet sind. |
| **Februar 2024** | |
...
| Es wurde klargestellt, dass bestimmte Informationen nur für Admins verfügbar sind | Informationen wurden hinzugefügt, die darauf hinweisen, dass die Spalten „Zuletzt verwendet“ und „Verwendet in“, die in [Manager für berechnete Metriken](/help/components/calc-metrics/cm-workflow/cm-manager.md) und der [Segment-Manager](/help/components/filters/manage-filters.md) beschrieben werden, nur für Systemadministratoren verfügbar sind. |
...
| Exportieren von vollständigen Tabellen in die Cloud | Es wurde eine Dokumentation zum Exportieren vollständiger Tabellen mit Millionen von Workspace-Zeilen in Cloud-Ziele hinzugefügt. <p>Der Export vollständiger Tabellen ermöglicht die einmalige oder geplante Bereitstellung von in Workspace entworfenen Datentabellen mit Unterstützung für bis zu fünf Aufschlüsselungen, fünf Metriken, Segmente und berechnete Metriken in einer verketteten Tabelle. Es ist die Weiterentwicklung von Data Warehouse-Berichten in Adobe Analytics, mit vielen neuen, häufig angeforderten Funktionen, die heute nicht in Data Warehouse verfügbar sind.</p><p>Weitere Informationen finden Sie unter [Exportieren von Customer Journey Analytics-Berichten in die Cloud](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/export/export-cloud.html?lang=de). |
...
| **April 2023** |  |
| Video zur Verwendung von Segmenten als Dimensionen | Das Video zur Verwendung von Segmenten als Dimensionen wurde aktualisiert. <p>Dieses Video ist von der Seite [Segmente erstellen“ ](/help/components/filters/create-filters.md).</p> <p>Im Folgenden finden Sie einen direkten Link zum Video: [Verwenden von Segmenten als Dimensionen in Analysis Workspace](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/components/filters/use-filters-as-dimensions.html?lang=de).</p> |
| Segmentdokumentation | Es wurde ein Artikel zur Verwendung von [Segment Builder](/help/components/filters/filter-builder.md) hinzugefügt. <p>Die Dokumentation in [Segmente erstellen](/help/components/filters/create-filters.md) und [Segmentierungsübersicht](/help/components/filters/filters-overview.md) wurde vereinheitlicht.</p> |
...
| Projektsegmente (Ad-hoc- und Schnellsegmente) | Die Dokumentation zu Projektsegmenten wurde vereinheitlicht und duplizierte Informationen wurden entfernt. Die Schritte zum Erstellen von Ad-hoc-Segmenten sind jetzt mit den Schritten zum [Erstellen von Schnellsegmenten](/help/components/filters/quick-filters.md) zusammengelegt. |
| **März 2023** | |
...
| --- | --- |
| **Dezember 2022** |  |
| 16. Dezember 2022 | Neuer Artikel [Verwalten der Datennutzung in Customer Journey Analytics](/help/technotes/estimate-usage.md). |
| **Oktober 2022** | |
...
| **Oktober 2021** | |
| Oktober 2021 | Dokumentation für [Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/report-buider-overview.html?lang=de#) in Customer Journey Analytics. |
