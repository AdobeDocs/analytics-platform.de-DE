...
| **März 2025** | |
| Anwendungsfälle für Quantum Metric | Es wurden Anwendungsfälle für die Erfassung von Daten aus der [Quantum Metric](/help/use-cases/third-party/quantum-metric/collect-session-id.md) hinzugefügt. |
| **Februar 2025** |  |
...
| Asset-Übertragung | Diese Funktion ermöglicht die [Übertragung der Eigentümerschaft](https://experienceleague.adobe.com/de/docs/analytics-platform/using/tools/asset-transfer/transfer-assets) an Komponenten wie Projekten, Filtern und berechneten Metriken an andere Benutzende, um Kontinuität und einen angemessenen Zugriff sicherzustellen.  |
...
| Zusätzliche Informationen in der Spalte „Verwendet in“ im Manager für berechnete Metriken und im Filter-Manager | Die Spalte „Verwendet in“ im [Manager für berechnete Metriken](https://experienceleague.adobe.com/de/docs/analytics-platform/using/cja-components/cja-calcmetrics/cm-workflow/cm-manager?lang=de) und im [Filter-Manager](https://experienceleague.adobe.com/de/docs/analytics-platform/using/cja-components/cja-filters/manage-filters?lang=de) enthält die folgenden neuen Reporting-Bereiche: Report Builder und Ad-hoc-Komponenten. |
| **August 2024** | |
...
| Es wurde eine Dokumentation zur Erweiterung der Berechtigungen für projektspezifische Workspace-Komponenten hinzugefügt | Wenn Sie ein Projekt für andere Benutzende freigeben, können diese Benutzenden [Schnellfilter](/help/components/filters/quick-filters.md) und andere projektspezifische Komponenten bearbeiten, die in das freigegebene Projekt eingebettet sind. |
| **Februar 2024** | |
...
| Projektfilter (Ad-hoc- und Schnellfilter) | Die Dokumentation zu Projektfiltern wurde vereinheitlicht und duplizierte Informationen wurden entfernt. Die Schritte zum Erstellen von Ad-hoc-Filtern sind jetzt mit den Schritten zum [Erstellen von Schnellfiltern](/help/components/filters/quick-filters.md) kombiniert. |
| **März 2023** | |
