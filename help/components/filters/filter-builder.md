...
| **[!UICONTROL Nicht wiederholende Instanz]** | Schließen Sie eindeutige Instanzwerte (nicht wiederholende) für die Dimension ein, um die Qualifizierung zu bestimmen. |
