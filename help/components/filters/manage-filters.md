...
| **[!UICONTROL Titel und Beschreibung]** | Um den Filter zu bearbeiten, wählen Sie den Titel-Link aus, der den [Filter-Builder](filter-builder.md) öffnet. Ein freigegebener Filter wird mit ![Freigabe](/help/assets/icons/Share.svg) angegeben. |
