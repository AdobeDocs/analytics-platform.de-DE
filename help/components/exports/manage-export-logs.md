...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * [Passen Sie die angezeigten Spalten an.](#configure-columns)

   * Wählen Sie das Symbol **Informationen** ![Informationen](assets/information-icon.png) neben dem Protokollnamen aus, um den mit dem Protokoll verknüpften Export anzuzeigen.
...
1. Wählen Sie das Symbol **Filter** aus.
   ...
   ![Fenster &quot;Exporte&quot;mit der Liste &quot;Filter nach Kontotyp&quot;](assets/export-log-filters.png)
   ...
   | [!UICONTROL **Status**] | Der Status des Exports. Die folgenden Status sind verfügbar: <ul><li>[!UICONTROL **Ausstehend**]: Eine bestimmte Instanz eines Exports wurde gestartet, ist jedoch noch nicht abgeschlossen.<p>Wenn Sie einen Export mit dem Status Ausstehend erneut ausführen, wird der Exportvorgang verzögert.</p></li><li>[!UICONTROL **Abgeschlossen**]: Eine bestimmte Instanz eines Exports wurde fertig verarbeitet und ist im Exportkonto verfügbar.</li><li>[!UICONTROL **Fehlgeschlagen**]<p>Verschiedene Situationen können zu einem fehlgeschlagenen Export führen. Bewegen Sie den Mauszeiger über den Status Fehlgeschlagen , um Details zum Fehler anzuzeigen.<p>Weitere Informationen zu möglichen Ursachen für einen Fehler finden Sie unter [Fehlerbehebung bei fehlgeschlagenen Exporten](/help/components/exports/troubleshoot-exports.md).</p> |
...
1. Wählen Sie neben dem Protokollnamen das Symbol **Export bearbeiten** ![Protokoll-Exportsymbol](assets/export-icon.png) aus.

   Oder

   Aktivieren Sie das Kontrollkästchen neben dem Protokoll und wählen Sie dann [!UICONTROL **Export bearbeiten**] aus.

## Spalten konfigurieren

Sie können auf der Registerkarte [!UICONTROL Protokolle] Spalten hinzufügen oder entfernen, um zu konfigurieren, welche Informationen angezeigt werden.
...
1. Wählen Sie das Symbol **Tabelle anpassen** ![Tabelle anpassen](assets/customize-table-icon.png) oben rechts auf der Seite [!UICONTROL Protokolle] aus.

   Die folgenden Spalten sind verfügbar:

   | Spalte verfügbar | Beschreibung |
   |---------|----------|
   | Exportname | Der Name des Exports. Benutzer benennen Exporte, wenn sie sie erstellen, wie unter [Customer Journey Analytics-Berichte in die Cloud exportieren](/help/analysis-workspace/export/export-cloud.md) beschrieben. |
...
1. Stellen Sie sicher, dass alle Spalten ausgewählt sind, die angezeigt werden sollen. Die ausgewählten Spalten werden auf der Seite [!UICONTROL Protokolle] angezeigt und zeigen die relevanten Informationen an.
