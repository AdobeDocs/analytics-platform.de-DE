...
Sie können nur die von Ihnen erstellten Exporte sehen. Administratoren können alle Exporte anzeigen, indem sie die Option **[!UICONTROL Exporte für alle Benutzer anzeigen]** aktivieren.
...
1. Wählen Sie die [!UICONTROL **Exporte**] aus.
   ...
   ![Seite „Exporte verwalten“](assets/exports-manage.png)

1. Wählen Sie das **Filter**-Symbol ![Filtersymbol](/help/assets/icons/Filter.svg) aus.
   ...
   | [!UICONTROL **Status**] | Der Status des Exports Die folgenden Status sind verfügbar: <ul><li>[!UICONTROL **Aktiv**]: Gibt an, dass ein geplanter Export noch nicht abgelaufen ist oder dass ein einmaliger Export noch nicht abgeschlossen ist. </li><li>[!UICONTROL **Abgeschlossen**]: Gibt an, dass ein Export erfolgreich exportiert wurde. Für geplante Exporte bedeutet dies, dass der Zeitplan abgelaufen ist.</li><li>[!UICONTROL **Fehlgeschlagen**]<p>Die folgenden Situationen können zu einem fehlgeschlagenen Export führen. Bewegen Sie den Mauszeiger über [!UICONTROL **Status**] Fehlgeschlagen“, um Details zum Fehler anzuzeigen. <ul><li>Geplanter Exportablauf</li><li>Zeilenbeschränkung für geplanten Export erreicht </li></ul><li>[!UICONTROL **Abgelaufen**]: Gibt an, dass der Export abgelaufen ist.</li></ul> |
   | [!UICONTROL **Erstellt von**] | Der Benutzer, der den Export erstellt hat.<p>Diese Option steht nur Administratoren zur Verfügung, wenn die Option **[!UICONTROL Exporte für alle Benutzer anzeigen]** aktiviert ist. |
...
1. Aktualisieren Sie eine der verfügbaren Optionen. Informationen zu den einzelnen Optionen finden Sie unter [Exportieren von vollständigen Tabellen aus Analysis Workspace](/help/analysis-workspace/export/export-cloud.md#export-full-tables) in [Exportieren von Customer Journey Analytics-Berichten in die Cloud](/help/analysis-workspace/export/export-cloud.md).

## Export erneuern

Sie können einen oder mehrere geplante Exporte vor oder nach ihrem Ablauf erneuern. Die Exporte werden für 1 Jahr ab dem Datum ihrer Erneuerung erneuert.

1. Wählen Sie in Customer Journey Analytics [!UICONTROL **Komponenten**] > [!UICONTROL **Exporte**] aus.

1. Aktivieren Sie auf [!UICONTROL **Registerkarte**] Exporte“ das Kontrollkästchen neben einem oder mehreren Exporten, die Sie erneuern möchten.

1. Wählen Sie [!UICONTROL **Verlängern**] aus.

   Das [!UICONTROL **Exportieren der vollständigen Tabelle**] Dialogfeld wird angezeigt. <!--check process from here. -->
...
Sie können Exporte auf der Seite Exporte löschen. Wenn Sie einen Export löschen, wird er von der Seite „Exporte“ entfernt. Geplante Exporte, die gelöscht werden, werden abgebrochen und können nicht mehr gesendet werden.
...
## Erstellen eines Exports aus der Seite Exporte

Sie können einen Export entweder über Analysis Workspace erstellen, wie unter [Exportieren vollständiger Tabellen in die Cloud](/help/analysis-workspace/export/export-cloud.md) beschrieben, oder über die Seite Exporte , wie in diesem Abschnitt beschrieben.

So erstellen Sie einen Export über die Seite „Exporte“:

1. Wählen Sie in Customer Journey Analytics [!UICONTROL **Komponenten**] > [!UICONTROL **Exporte**] aus.

1. Wählen Sie auf der [!UICONTROL **Exporte**] die Option **[!UICONTROL Export hinzufügen]** aus.

1. Füllen Sie die verfügbaren Felder aus, um den Export zu erstellen. Informationen zu den einzelnen Feldern sowie Informationen zu Komponenten, Funktionen für berechnete Metriken und anderen unterstützten Funktionen finden Sie unter [Exportieren vollständiger Tabellen in die Cloud](/help/analysis-workspace/export/export-cloud.md).
