...
1. Beginnen Sie mit der Erstellung eines Warnhinweises, indem Sie auf die Warnhinweiserstellung zugreifen. <!-- add this back in after the other methods are available like in AA and make a bulleted list: "You can access the alert builder in any of the following ways:" --> Wählen Sie unter Customer Journey Analytics die Option **[!UICONTROL Komponenten]** > [!UICONTROL **Warnhinweise**] > **[!UICONTROL Neuen Warnhinweis erstellen]** aus.
