...
*In diesem Artikel wird die Fallout-Visualisierung in **Customer Journey Analytics.**. Siehe [Fallout](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/fallout/fallout-flow) für die **Adobe Analytics**-Version dieses Artikels.*
