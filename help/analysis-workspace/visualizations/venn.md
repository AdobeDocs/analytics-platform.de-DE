...
*In diesem Artikel wird die Venn-Visualisierung in **Customer Journey Analytics.**.<br/>Siehe [Venn](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/venn) für die **Adobe Analytics**-Version dieses Artikels.*
