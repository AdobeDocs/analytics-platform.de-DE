...
*In diesem Artikel wird die Flussvisualisierung in **Customer Journey Analytics.**.<br/>Siehe [Fluss](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/flow/flow) für die **Adobe Analytics**-Version dieses Artikels.*
