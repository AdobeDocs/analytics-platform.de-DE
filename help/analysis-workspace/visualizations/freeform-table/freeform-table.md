...
*In diesem Artikel wird die Freiformtabellen-Visualisierung in **Customer Journey Analytics.**.<br/>Siehe [Freiformtabelle](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/freeform-table/freeform-table) für die **Adobe Analytics**-Version dieses Artikels.*
