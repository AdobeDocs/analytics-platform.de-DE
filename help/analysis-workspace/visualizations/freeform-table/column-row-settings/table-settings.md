...
Das folgende Beispiel zeigt, wie die Kontextmenüoptionen **[!UICONTROL Ausgewählte Zeile umbenennen]**, **[!UICONTROL Ausgewählte Zeilen]** und **[!UICONTROL Als abgeleitetes Feld erstellen]** verwendet werden. und wie die geänderte Freiformtabelle zurückgesetzt wird.
...
* Setzen Sie die Freiformtabelle auf den Status vor den Änderungen zurück.
  ...
  1. Wählen Sie **[!UICONTROL Geänderte Zeilen zurücksetzen]** aus dem Popup **[!UICONTROL Zeilen umbenannt]** aus.
