...
1. Bearbeiten [ das Segment im ](/help/components/filters/filter-builder.md) weiter und klicken Sie dann auf **[!UICONTROL Speichern]**.

   Das gespeicherte Segment kann im Bedienfeld [!UICONTROL Filter“ ] [!UICONTROL Analysis Workspace} verwendet ].
