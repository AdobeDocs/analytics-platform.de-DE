...
* Vermeiden Sie Implementierungsänderungen: Bei der Berichtszeitverarbeitung und kontextabhängigen Sitzungen kann der Kunden-Journey-Kontext zur Laufzeit integriert und angewendet werden.
...
Siehe ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Attribution in Freiformtabellen](https://video.tv.adobe.com/v/37474?captions=ger&quality=12&learn=on){target="_blank"} für ein Demovideo.
...
Siehe ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Attribution in berechneten &#x200B;](https://video.tv.adobe.com/v/41478?captions=ger&quality=12&learn=on){target="_blank"}) für ein Demovideo.
...
Siehe ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Verwenden des Attributionsbedienfelds](https://video.tv.adobe.com/v/37477?captions=ger&quality=12&learn=on){target="_blank"} für ein Demovideo.
...
Siehe ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Hinzufügen von nebeneinander angezeigten Vergleichen von Attributionsmodellen](https://video.tv.adobe.com/v/327794?captions=ger&quality=12&learn=on){target="_blank"} für ein Demovideo.
