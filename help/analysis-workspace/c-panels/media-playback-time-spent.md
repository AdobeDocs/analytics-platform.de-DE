...
| Zeitformat | Sie können die Wiedergabedauer entweder in `Hours:Minutes:Seconds` (Standard) oder in `Minutes` anzeigen (die in Ganzzahlen angezeigt wird, auf 0,5 aufgerundet). |
