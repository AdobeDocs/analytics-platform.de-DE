...
*Dieser Artikel dokumentiert das leere Bedienfeld in **Customer Journey Analytics**.<br/>Siehe [Leeres Bedienfeld](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/blank-panel) für die **Adobe Analytics**-Version dieses Artikels.*
