...
## Exportieren vollständiger Tabellen aus Analysis Workspace {#export-from-workspace}
...
## Anforderungen und nicht unterstützte Funktionen {#export-requirements}

In diesem Abschnitt werden die Mindestanforderungen und nicht unterstützten Funktionen beschrieben, die Sie beim Exportieren von Daten berücksichtigen sollten.
...
## Vergleich des vollständigen Tabellenexports (in Customer Journey Analytics) nach Data Warehouse (in Adobe Analytics) {#comparison}
