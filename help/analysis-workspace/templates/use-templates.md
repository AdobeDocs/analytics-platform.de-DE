---
description: Erfahren Sie mehr über die Standardvorlagen in Analysis Workspace und wie Sie diese verwenden.
...
1. Wählen Sie im Abschnitt [!UICONTROL **Vorlagen**] eine der folgenden Registerkarten aus:
   ...
   * **[!UICONTROL _Unternehmens _Anmeldename_-Vorlagen]**: Zeigt alle Unternehmensvorlagen an, die für Ihre Organisation erstellt wurden.
...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * Ziehen Sie ein oder mehrere Segmente in die Ablagezone für Segmente oben. Ziehen Sie beispielsweise das Segment [!UICONTROL **Mobile-Kunden**] und sehen Sie sich die Ergebnisse an.
...
Greifen Sie wie folgt auf alle verfügbaren vorkonfigurierten Vorlagen zu:
...
>title="Zeigen Sie die Gesamtanzahl der bei allen Bestellungen gekauften Einheiten an. Die Daten werden für einen bestimmten Zeitraum angezeigt und mit früheren Zeiträumen verglichen."
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, wie Verkäufe von Einheiten im Laufe der Zeit zu- oder abnehmen. Sie können ein Segment anwenden, um zu erfahren, welche Kundinnen und Kunden oder Regionen die meisten Einheiten kaufen und wie der Trend bei den Verkäufen dieser Einheiten im Laufe der Zeit aussieht.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Effektivität einer kürzlich gestarteten Marketing-Kampagne bewerten, indem Sie Verkäufe von Einheiten vor und nach dem Start der Kampagne vergleichen. Oder Sie vergleichen die Stückzahlen während der Feiertage im Jahresvergleich.<br/>Diese Vorlage verwendet die Dimension „Tag“ und die Metrik „Einheit“."
...
| [!UICONTROL **Web-Besuchende**] | <!--duplicated in Engagement section--> Zeigen Sie die Gesamtanzahl der Metrik „Unique Visitors“ an. Die Daten werden für einen bestimmten Zeitraum angezeigt und mit früheren Zeiträumen verglichen. <p>**Dies kann Ihnen helfen**, besser zu verstehen, wie die Reichweite und die Zielgruppengröße Ihrer Site im Laufe der Zeit oder im Vergleich mit einem früheren Zeitraum zu- oder abnimmt.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. bewerten, ob eine kürzlich gestartete Marketing-Kampagne erfolgreich darin war, neue Personen auf die Site zu locken, indem Sie Unique Visitors vor und nach dem Start der Kampagne vergleichen. Oder Sie können die Anzahl der Personen vergleichen, die die Site jedes Jahr während der Feiertage besuchen.</p><p>Diese Vorlage verwendet die Dimension „Tag“ und die Metrik „Unique Visitors“.</p> |
...
| [!UICONTROL **Letztkontakt-Kanal**] | Zeigen Sie die neuesten Marketing-Kanäle an, denen Besuchende während ihres Interaktionszeitraums (standardmäßig 30 Tage) zugeordnet werden.<p>**Dies kann Ihnen dabei helfen**, zu verstehen, welche Marketing-Kanäle am effektivsten waren, um Personen zu Ihrer Site zu leiten und um Konversionen zu erreichen.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. mehr Ressourcen für leistungsstarke Kanäle oder weniger Ressourcen für leistungsschwache Kanäle zuweisen.</p><p>Diese Vorlage verwendet die Dimension „Letztkontaktkanal“ und die Metrik „Unique Visitors“.</p> |
...
>title="Zeigen Sie die Anzahl der Besuche an, die nur eine einzelne Seite umfassten."
...
>title="Zeigen Sie Leistungsdaten für Ihre Adobe Experience Manager-Formulare an."
>abstract="**Dies kann Ihnen helfen**, die Wertrealisierung von Adobe Experience Manager besser zu verstehen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Einstellungen von Experience Manager optimieren."

>[!CONTEXTUALHELP]
>id="aa-template--itp-impact"
>title="Zeigen Sie die Auswirkungen der Intelligent Tracking Prevention (ITP) auf die Datenerfassung und das Reporting an und analysieren Sie diese."
>abstract="**Dies kann Ihnen helfen**, potenzielle Datenverluste aufgrund von Cookie-Beschränkungen durch ITP besser zu verstehen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Ihr Analyse-Setup anpassen, um die Auswirkungen von ITP zu minimieren."
...
>title="Zeigen Sie die Top-Seiten an, auf die Personen beim ersten Besuch Ihrer Site zugreifen."
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, welche Seiten den meisten Traffic zu Ihrer Site leiten, oder mehr über die ersten Eindrücke zu erfahren, die Besuchende auf Ihrer Site haben.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. das erste Erlebnis optimieren, das Personen auf der Site haben, oder sicherstellen, dass die Seiten, die Personen beim Eintritt in Ihre Site zuerst sehen, einladend sind und die erforderlichen Links zu anderen Bereichen Ihrer Site bereitstellen.<br/>Diese Vorlage verwendet die Metrik „Sitzungen“. Außerdem werden die Visualisierungen „Balken“ und „Freiformtabelle“ verwendet."

>[!CONTEXTUALHELP]
>id="template--exitpagerankedreport"
>title="Zeigen Sie die Top-Seiten an, auf die Personen unmittelbar vor dem Verlassen Ihrer Site zugreifen."
...
>abstract="**Dies kann Ihnen helfen**, zu verstehen, wie Ihre Inhalte auf granularer Ebene funktionieren. Sie können die Leistung einzelner Assets oder bestimmter Attribute überprüfen. Content Analytics verwendet KI, um automatisch Attribute zu generieren und Ihre Inhalte mit Tags zu versehen. [Weitere Informationen](https://experienceleague.adobe.com/de/docs/analytics-platform/using/content-analytics/content-analytics).<br/>**Basierend auf Ihren Erkenntissen können Sie** eine Reihe von Schritten ausführen, z. B. leistungsstarke Assets auf Ihrer Startseite bewerben, Inhalte für bestimmte Segmente personalisieren, sodass sie leistungsstarke Attribute beinhalten, oder mittlerweile veraltete Inhalte austauschen."



>[!CONTEXTUALHELP]
>id="template--content-analytics-paid-media"
>title="Erfahren Sie, welche Paid-Media-Inhalte und -Inhaltsattribute die beste Leistung erbringen."
>abstract="**Dies kann Ihnen helfen** zu verstehen, wie Ihre Paid-Media-Inhalte auf granularer Ebene funktionieren. Sie können die Reichweite, Interaktion, Ausgaben und Effizienz von Paid Media in Netzwerken, Konten, Kampagnen, Erlebnissen und Assets überprüfen. Die Metriken und Dimensionen in diesem Panel bleiben absichtlich in der Asset-Zusammenfassung für Paid Media. Kombinieren Sie Zusammenfassungsdatensätze nicht mit Ereignisdaten.  [Weitere Informationen](https://experienceleague.adobe.com/de/docs/analytics-platform/using/content-analytics/content-analytics).<br/>**Je nachdem, was Sie in Erfahrung bringen**, können Sie verschiedene Dinge tun, z. B. sich darauf konzentrieren, wie Sie Geld für Ihre Paid-Media-Kanäle ausgeben, mehr Geld für Kampagnen mit geringer Leistung ausgeben oder mehr Geld für Kampagnen mit leistungsstarken Assets ausgeben."
...
| **Paid Media Content Analytics** | Erfahren Sie, welche Paid-Media-Inhalte und -Inhaltsattribute die beste Leistung erbringen.<p>**Dies kann Ihnen helfen** zu verstehen, wie Ihre Paid-Media-Inhalte auf granularer Ebene funktionieren. Sie können die Reichweite, Interaktion, Ausgaben und Effizienz von Paid Media in Netzwerken, Konten, Kampagnen, Erlebnissen und Assets überprüfen. Die Metriken und Dimensionen in diesem Panel bleiben absichtlich in der Asset-Zusammenfassung für Paid Media. Kombinieren Sie Zusammenfassungsdatensätze nicht mit Ereignisdaten. Weitere Informationen finden Sie unter [Content Analytics](/help/content-analytics/content-analytics.md).<p/><p>**Je nachdem, was Sie in Erfahrung bringen**, können Sie verschiedene Dinge tun, z. B. sich darauf konzentrieren, wie Sie Geld für Ihre Paid-Media-Kanäle ausgeben, mehr Geld für Kampagnen mit geringer Leistung ausgeben oder mehr Geld für Kampagnen mit leistungsstarken Assets ausgeben.</p> |
...
>title="Zeigen Sie vorkonfigurierte Erkenntnisse für Einzelhändler zu Ihren Handelsaktivitäten an, die Ihnen helfen können, den Umsatz zu steigern. Dies richtet sich vor allem an Benutzende von Adobe Commerce, kann aber von jedem Online-Einzelhändler genutzt werden."
...
>title="Zeigen Sie die Produktkonversion in einer Trichtervisualisierung an, die Warenkörbe, Checkouts und Bestellungen darstellt. Sie können auch Konversionsprozentsätze sowie Durchschnittswerte von Umsätzen, Einheiten und Bestellungen anzeigen."
...
>title="Zeigen Sie an, welche Produkte die höchste Leistung erbringen."
...
>title="Zeigen Sie an, wie oft Personen wichtige Checkout-Ereignisse ausgeführt haben, z. B. Hinzufügen von Artikeln zum Warenkorb, Anzeigen des Warenkorbs, Entfernen von Artikeln aus dem Warenkorb und Checkout."
...
>title="Zeigen Sie an, welche Zielgruppen unter den Personen vertreten sind, die Ihre Site besuchen."
>abstract="**Dies kann Ihnen helfen**, allgemeine Informationen zu den Zielgruppen, dem Ursprung der Zielgruppen (RTCDP, Customer Journey Analytics), Zielgruppenüberschneidungen und vieles mehr besser zu verstehen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Daten verwenden, um sich auf Marketing-Maßnahmen für diese bestimmten Zielgruppen zu konzentrieren oder maßgeschneiderte Erlebnisse für Kundinnen und Kunden zu schaffen, die mehrere Zielgruppen umfassen.<br/>Diese Vorlage verwendet die Dimensionen „Zielgruppenname“, „Ursprung der Zielgruppe“, „Name der ausgestiegenen Zielgruppe“ und „Ursprung der ausgestiegenen Zielgruppe“."
...
>[!CONTEXTUALHELP]
>id="template--bots"
>title="Zeigen Sie Seitenaufrufe und Trends in Bezug auf den Bot-Traffic auf Ihrer Site an."
...
>title="Zeigen Sie die Top-Browser-Breiten an, mit denen Personen auf Ihre Site zugreifen."
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, wie Inhalte Besuchenden angezeigt werden.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Site-Qualität durch Testen neuer Versionen Ihrer Site mit den gängigsten Browser-Breiten verbessern. Auf diese Weise maximieren Sie Ihre Maßnahmen zur Qualitätssicherung.<br/>Diese Vorlage verwendet die Dimension „Browser“."

>[!CONTEXTUALHELP]
>id="aa-template--browserheightrankedreport"
>title="Zeigen Sie die Top-Browser-Höhen an, mit denen Personen auf Ihre Site zugreifen."
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, wie Inhalte Besuchenden angezeigt werden.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Site-Qualität durch Testen neuer Versionen Ihrer Site mit den gängigsten Browser-Höhen verbessern. Auf diese Weise maximieren Sie Ihre Maßnahmen zur Qualitätssicherung.<br/>Diese Vorlage verwendet die Dimension „Browser“. "
...
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, wie sehr Besuchende interagieren, wenn sie zu Ihrer Site zurückkehren. Dies gilt für die gesamte Lebenszeit der Besucherin bzw. des Besuchers, unabhängig vom Datumsbereich des Projekts.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Marketing-Aufwände für häufige Besuchende anpassen.<br/>Diese Vorlage verwendet die Dimension „Anzahl der Besuche“."
...
>title="Sehen Sie sich an, wie viele Tage zwischen dem ersten Besuch einer Besucherin bzw. eines Besuchers auf Ihrer Site und einem Kauf vergehen. Wenn ein Besucher beispielsweise einen Tag nach dem ersten Besuch einen Kauf tätigt, gehören alle nachfolgenden Besuche und Ereignisse zum Dimensionselement „1 Tag“."
...
>title="Zeigen Sie die Zeitdauer an, die zwischen dem aktuellen Treffer der Besucherin bzw. des Besuchers und seinem letzten Kauf zu diesem Zeitpunkt verstrichen ist."
...
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, wie Inhalte den Besuchenden angezeigt werden.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Site-Qualität durch Testen neuer Versionen Ihrer Site mit den gängigsten Bildschirmgrößen von Mobilgeräten verbessern. Auf diese Weise maximieren Sie Ihre Maßnahmen zur Qualitätssicherung."
...
>title="Zeigen Sie Besuchende basierend auf Daten über die Zustimmung zur Einverständnisrichtlinie von Adobe Experience Platform an."
>abstract="**Dies kann Ihnen** als Ausgangspunkt für das Reporting über die Zustimmung zur Einverständnisrichtlinie von Besuchenden dienen. Wenn eine Datenansicht für das Einverständnis-Reporting konfiguriert ist, stellt Customer Journey Analytics automatisch eine Vorlage für die Analyse von Einverständnisrichtlinien in Analysis Workspace zur Verfügung. <br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Besuchenden vom Analyse-Reporting ausschließen, die kein Einverständnis geben."
...
>title="Zeigen Sie den Namen und die Version der Top-Browser an, die für den Zugriff auf Ihre Site verwendet werden."
>abstract="**Dies kann Ihnen dabei helfen**, die gängigsten Browser, die beim Besuch verwendet werden, besser zu verstehen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Site-Qualität durch Testen neuer Versionen Ihrer Site mit den wichtigsten Browsern verbessern. Auf diese Weise maximieren Sie Ihre Maßnahmen zur Qualitätssicherung.<br/>Diese Vorlage verwendet die Dimension „Browser“."

>[!CONTEXTUALHELP]
>id="template--browsertyperankedreport"
>title="Zeigen Sie die Namen der Organisationen an, die die Top-Browser erstellt haben, mit denen Personen auf Ihre Site zugreifen. Diese Vorlage unterscheidet sich insofern von der Vorlage „Browser“, als sie verschiedene Versionen desselben Browsers nicht als separate Dimensionselemente auflistet."
>abstract="**Dies kann Ihnen dabei helfen**, die gängigsten Browser, die Besuchende verwenden, besser zu verstehen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Site-Qualität verbessern, indem Sie neue Versionen Ihrer Site mit den wichtigsten Browsern testen. Auf diese Weise maximieren Sie Ihre Maßnahmen zur Qualitätssicherung. <br/>Diese Vorlage verwendet die Dimension „Browsertyp“. "
...
&#x200B;| Vorlagenname | Warum diese Vorlage verwenden?<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- |
| [!UICONTROL **Übersicht über die Einverständnisrichtlinie**] | Zeigen Sie Besuchende basierend auf Daten über die Zustimmung zur Einverständnisrichtlinie von Adobe Experience Platform an.<p>**Dies kann Ihnen** als Ausgangspunkt für das Reporting über die Zustimmung zur Einverständnisrichtlinie von Besuchenden dienen. Wenn eine Datenansicht für das Einverständnis-Reporting konfiguriert ist, stellt Customer Journey Analytics automatisch eine Vorlage für die Analyse von Einverständnisrichtlinien in Analysis Workspace zur Verfügung. <br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Besuchenden vom Analyse-Reporting ausschließen, die kein Einverständnis geben.</p> |
...
| [!UICONTROL **Erstmalige vs. wiederkehrende Besuchende**] | Zeigen Sie eine Ansicht des Vergleichs zwischen erstmaligen und wiederkehrenden Besuchenden an. <p>**Dies kann Ihnen helfen**, die Effektivität Ihrer Site bei der Kundenbindung oder die Rate, mit der Sie neue Kundschaft gewinnen, besser zu verstehen.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. erstmaligen Besuchenden Anreize für zukünftige Käufe anbieten, um sie zur Rückkehr zu bewegen.</p><!-- This template uses the --> |
| **Personen-ID** | Zeigen Sie eine Ansicht des individuellen Benutzerverhaltens über verschiedene Kanäle hinweg an.<p>**Dies kann Ihnen helfen**, die gesamte Customer Journey und alle Interaktionen Touchpoint-übergreifend besser zu verstehen.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Marketing-Maßnahmen genauer auf Benutzervorlieben ausrichten.</p><!-- This template uses the --> |
...
| **Geo-Städte** | Zeigen Sie die Stadt an, aus der die Personen stammen, die Ihre Website besuchen. <p>**Dies kann Ihnen helfen**, besser zu verstehen, aus welchen Städten die meisten Personen stammen, die Ihre Site besuchen.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Daten verwenden, um sich auf Marketing-Maßnahmen in diesen Städten zu konzentrieren. </p><p>Diese Vorlage verwendet die Dimension „Städte“. </p> |
| **DMA zu Geo-USA** | Zeigen Sie die designierten Marketing-Bereiche (DMAs) in den USA an, aus denen die Personen stammen, die Ihre Website besuchen.<p>**Dies kann Ihnen helfen**, besser zu verstehen, aus welchen Regionen die meisten Personen stammen, die Ihre Site besuchen.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Daten verwenden, um sich auf Marketing-Maßnahmen in der erfolgreichsten Regionen zu konzentrieren. </p><!-- This template uses the --> |
...
| **Browser** | Zeigen Sie den Namen und die Version der Top-Browser an, die für den Zugriff auf Ihre Site verwendet werden.<p>**Dies kann Ihnen dabei helfen**, die gängigsten Browser, die beim Besuch verwendet werden, besser zu verstehen.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Site-Qualität durch Testen neuer Versionen Ihrer Site mit den wichtigsten Browsern verbessern. Auf diese Weise maximieren Sie Ihre Maßnahmen zur Qualitätssicherung.</p><p>Diese Vorlage verwendet die Dimension „Browser“. </p> |
| **Browser-Typen** | Zeigen Sie die Namen der Organisationen an, die die Top-Browser erstellt haben, mit denen Personen auf Ihre Site zugreifen. Diese Vorlage unterscheidet sich insofern von der Vorlage „Browser“, als sie verschiedene Versionen desselben Browsers nicht als separate Dimensionselemente auflistet.<p>**Dies kann Ihnen dabei helfen**, die gängigsten Browser, die von Besuchenden verwendet werden, besser zu verstehen</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Site-Qualität durch Testen neuer Versionen Ihrer Site mit den wichtigsten Browsern verbessern. Auf diese Weise maximieren Sie Ihre Maßnahmen zur Qualitätssicherung. </p><p>Diese Vorlage verwendet die Dimension „Browser-Typ“. </p> |
...
>title="Zeigen Sie den ersten Marketing-Kanal an, dem Besuchende während ihres Interaktionszeitraums (standardmäßig 30 Tage) zugeordnet werden."
...
>title="Zeigen Sie Details zum ersten Marketing-Kanal an, dem Besuchende während ihres Interaktionszeitraums (standardmäßig 30 Tage) zugeordnet werden."
...
>title="Zeigen Sie die erste Referrer-Domain an, über die Personen auf Ihre Site gelangt sind. (Sobald sie festgelegt wurde, enthält sie denselben Wert für die gesamte Lebensdauer dieser Besucher-ID.)"
...
| [!UICONTROL **Marketing-Kanäle**] > [!UICONTROL **Erstkontaktkanal**] | Zeigen Sie den ersten Marketing-Kanal an, dem Besuchende während ihres Interaktionszeitraums (standardmäßig 30 Tage) zugeordnet werden. <p>**Dies kann Ihnen helfen**, besser zu verstehen, welche Marketing-Kanäle den anfänglichen Traffic zu Ihrer Site leiten.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Marketing-Maßnahmen auf Bereiche konzentrieren, die am effektivsten sind.</p><p>Diese Vorlage verwendet die Dimension „Erstkontaktkanal“.</p> |
| [!UICONTROL **Marketing-Kanäle**] > [!UICONTROL **Detail des Erstkontaktkanals**] | Zeigen Sie Details zum ersten Marketing-Kanal an, dem Besuchende während ihres Interaktionszeitraums (standardmäßig 30 Tage) zugeordnet werden.<p>**Dies kann Ihnen helfen**, besser zu verstehen, was dazu beigetragen hat, dass der Treffer zu einem Marketing-Kanal passte. Wenn beispielsweise eine Besucherin oder ein Besucher zu Ihrer Site gelangt ist und mit dem Marketing-Kanal „Paid Search“ übereinstimmt, können Sie anhand des Kanaldetails sehen, welche Suchmaschine verwendet wurde oder nach welchem Keyword die Person gesucht hat.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Marketing-Maßnahmen auf Bereiche konzentrieren, die am effektivsten sind.</p><p>Diese Vorlage verwendet die Dimension „Detail des Erstkontaktkanals“.</p> |
| [!UICONTROL **Marketing-Kanäle**] > [!UICONTROL **Letztkontaktkanal**] | Zeigen Sie den letzten Marketing-Kanal an, der einer Besucherin bzw. einem Besucher während seines Interaktionszeitraums (standardmäßig 30 Tage) zugeordnet wird.<p>**Dies kann Ihnen helfen**, besser zu verstehen, welche Marketing-Kanäle zu Ihrer Site Traffic leiten, der zu Konversionen führt.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Marketing-Maßnahmen auf Bereiche konzentrieren, die am effektivsten sind.</p><p>Diese Vorlage verwendet die Dimension „Letztkontaktkanal“.  </p> |
| [!UICONTROL **Marketing-Kanäle**] > [!UICONTROL **Detail des Letztkontaktkanals**] | Zeigen Sie Details zum letzten Marketing-Kanal an, der einer Besucherin bzw. einem Besucher während seines Interaktionszeitraums (standardmäßig 30 Tage) zugeordnet wird.<p>**Dies kann Ihnen helfen**, besser zu verstehen, was dazu beigetragen hat, dass der Treffer zu einem Marketing-Kanal passte. Wenn beispielsweise eine Besucherin oder ein Besucher zu Ihrer Site gelangt ist und mit dem Marketing-Kanal „Paid Search“ übereinstimmt, können Sie anhand des Kanaldetails sehen, welche Suchmaschine verwendet wurde oder nach welchem Keyword die Person gesucht hat.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Marketing-Maßnahmen auf Bereiche konzentrieren, die am effektivsten sind. </p><p>Diese Vorlage verwendet die Dimension „Detail des Letztkontaktkanals“. </p> |
...
| **Verweisende Domains** | Zeigen Sie an, über welche Domains Besuchende auf Ihre Site gelangen.<p>**Dies kann Ihnen helfen**, besser zu verstehen, welche Sites von Drittanbietern den meisten Traffic zu Ihrer Site leiten. (Auf der externen Site muss ein Link vorhanden sein und Besuchende müssen darauf klicken, damit das Dimensionselement angezeigt wird.)</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Inhalte erstellen oder anpassen, um sie besser auf die Interessen der Besuchenden von Top-Referrer-Domains auszurichten. </p><p>Diese Vorlage verwendet die Dimension „Referrer-Domain“. </p> |
| **Ursprünglich verweisende Domains** | Zeigen Sie die erste Referrer-Domain an, über die Personen auf Ihre Site gelangt sind. (Sobald sie festgelegt wurde, enthält sie denselben Wert für die gesamte Lebensdauer dieser Besucher-ID.)<p>**Dies kann Ihnen helfen**, besser zu verstehen, welche Drittanbieter-Sites den Traffic ursprünglich zu Ihrer Site leiten.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Inhalte erstellen oder anpassen, um sie besser an die Interessen der Besuchenden von den ursprünglichen verweisenden Top-Domains anzupassen. </p><p>Diese Vorlage verwendet die Dimension „Ursprüngliche Referrer-Domain“. </p> |
| **Verweisende Stellen** | Zeigen Sie an, auf welchen URLs sich die Besuchenden befanden, als sie sich zu Ihrer Site durchklickten. (In der externen URL muss ein Link vorhanden sein und Besuchende müssen darauf klicken, damit das Dimensionselement angezeigt wird.)  <p>**Dies kann Ihnen helfen**, besser zu verstehen, welche spezifischen URLs den meisten Traffic zu Ihrer Site leiten.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Inhalte erstellen oder anpassen, um sie besser auf die Interessen der Besuchenden von Top-URLs auszurichten. </p><p>Diese Vorlage verwendet die Dimension „Referrer-Domain“. </p><p>Diese Vorlage verwendet die Dimension „Referrer“. </p> |
| **Typen der verweisenden Stellen** | Sehen Sie, über welche generischen Kanäle Besuchende auf Ihre Site gelangt sind. Adobe verwaltet die Regeln für jeden Kanal. Mögliche Kanäle sind Suchmaschinen, soziale Netzwerke, andere Websites, die Festplatte oder E-Mails.<p>**Dies kann Ihnen helfen**, besser zu verstehen, welche Referrer-Typen den meisten Traffic zu Ihrer Site leiten.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Inhalte erstellen oder anpassen, um sie besser an die Interessen der Besuchenden von einem bestimmten Kanal anzupassen.</p><p>Diese Vorlage verwendet die Dimension „Referrer-Typ“.</p> |

### Mobile: Mobile App {#mobile-app}

>[!CONTEXTUALHELP]
>id="template--mobileappscreens"
>title="Zeigen Sie die Anzahl der Ereignisse, Sitzungen und Personen an, die mit jedem Bildschirm in der App verknüpft sind."
...
>title="Zeigen Sie die Aktionen an, die Personen in Ihrer App durchführen."
...
>title="Zeigen Sie Ereignisse, Sitzungen und Personen auf Ihrer Site an, aufgeschlüsselt nach Vormittag und Nachmittag. Wenn es beispielsweise um einen Bericht für den Zeitraum 1. bis 7. Januar geht, werden die Stunden von 0 bis 12 Uhr jedes Tages in dasselbe Dimensionselement einsortiert."
...
>title="Zeigen Sie Ereignisse, Sitzungen und Personen auf Ihrer Site aufgeschlüsselt nach Wochentagen an. Wenn es beispielsweise um einen Bericht für den Januar geht, werden die einzelnen Wochentage in dasselbe Dimensionselement einsortiert."
...
>title="Zeigen Sie Ereignisse, Sitzungen und Personen auf Ihrer Site aufgeschlüsselt nach Tag des Jahres an. Wenn es beispielsweise um einen Bericht für mehrere Jahre geht, wird jeder Tag eines Jahres in daselben Dimensionselement gruppiert."
...
>title="Zeigen Sie Ereignisse, Sitzungen und Personen auf Ihrer Site aufgeschlüsselt nach Woche des Jahres an. Wenn Sie beispielsweise einen Bericht haben, der sich über mehrere Jahre erstreckt, wird jede Woche in derselben Dimension einsortiert."
...
>title="Zeigen Sie Ereignisse, Sitzungen und Personen auf Ihrer Site aufgeschlüsselt nach Monaten des Jahres an. Wenn Sie beispielsweise einen Bericht haben, der sich über mehrere Jahre erstreckt, wird jeder Monat in derselben Dimension einsortiert."
...
>title="Zeigen Sie Ereignisse, Sitzungen und Personen auf Ihrer Site aufgeschlüsselt nach Quartalen des Jahres an. Wenn Sie beispielsweise einen Bericht haben, der sich über mehrere Jahre erstreckt, wird jedes Quartal in demselben Dimensionselement einsortiert."
...
| **Analyse von Journey Optimizer-E-Mails** | Zeigen Sie an, wie die E-Mails, die Sie mit Adobe Journey Optimizer entwerfen und senden, neue Mitgliedschaften, Treueprogramm-Mitglieder und Crosssell-Möglichkeiten generieren. <p>**Dies kann Ihnen helfen**, die Effektivität der E-Mails, die Sie mit Adobe Journey Optimizer entwerfen und senden, besser zu verstehen.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Ihre E-Mail-Strategie für eine bestimmte E-Mail-Kampagne anpassen.</p> |
...
>title="Zeigen Sie wichtige Metriken für Ihre Adobe Journey Optimizer-Journeys an, darunter E-Mail-Journeys, Experimente, In-App-Nachrichten, SMS und mehr."
...
>abstract="**Dies kann Ihnen dabei helfen**, Interaktionsmuster zu identifizieren, die Gesprächsqualität zu bewerten, Trends bei der Kundenzufriedenheit zu verfolgen und die Effektivität von Link-Empfehlungen zu messen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. die Antworten Ihres AI Agent verfeinern, zielgerichtete Inhalte für häufig auftretende Probleme entwickeln, Empfehlungsalgorithmen verbessern oder spezialisierte Pfade für verschiedene Benutzersegmente erstellen."
...
>title="Erfahren Sie, wie aktiv Ihre Konten in Bezug auf Ereignisse, Personen und Opportunities sind."
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, ob die Interaktion auf Kontoebene tendenziell steigt oder sinkt, die Aktivitäten zwischen verschiedenen Konten zu vergleichen und zu entscheiden, wo Sie Ihre Bemühungen zur Kundenbindung oder Neukundengewinnung konzentrieren sollten.<br/>**Basierend auf Ihren Erkenntnissen können Sie** verschiedene Maßnahmen ergreifen, z. B. Ihre Aufmerksamkeit wieder auf diejenigen Konten richten, die weniger interagieren, aber aufgrund ihrer Bedeutung mehr Aufmerksamkeit erfordern."

>[!CONTEXTUALHELP]
>id="cja-template--b2b-opportunity-engagement"
>title="Verfolgen Sie die Interaktion auf Opportunity-Ebene und zeigen Sie Deals auf, die an Dynamik gewinnen oder verlieren."
>abstract="**Dies kann Ihnen helfen**, den Fortschritt eines Geschäfts genauer vorherzusagen und Ihre Maßnahmen dort zu konzentrieren, wo die Interaktion zunimmt oder stagniert.<br/>**Basierend auf Ihren Erkenntnissen können Sie** verschiedene Maßnahmen ergreifen, z. B. zusätzliche Anstrengungen für Geschäfte unternehmen, die kurz vor dem Abschluss stehen, und untersuchen, warum andere Geschäfte an Dynamik verlieren."

>[!CONTEXTUALHELP]
>id="cja-template--b2b-buying-group-activity"
>title="Visualisieren Sie die Käufergruppenaktivität innerhalb jedes Kontos, um Marketing-Maßnahmen für Kontos und Käufergruppen zu optimieren."
>abstract="**Dies kann Ihnen helfen**, zu visualisieren, welche Käufergruppen und welche Personen innerhalb dieser Käufergruppen am aktivsten sind, und Lücken in der Gruppenbeteiligung aufzuzeigen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** verschiedene Maßnahmen ergreifen, z. B. versuchen, mehr mit Personen in Käufergruppen zu interagieren, die nicht beteiligt zu sein scheinen."

Die folgenden Vorlagen sind verfügbar:

&#x200B;| Vorlagenname | Warum diese Vorlage verwenden?<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- |
| [!UICONTROL **Überblick über B2B-Konteninteraktion**] | Erfahren Sie, wie aktiv Ihre Konten in Bezug auf Ereignisse, Personen und Opportunities sind.<p>**Dies kann Ihnen helfen**, besser zu verstehen, ob die Interaktion auf Kontoebene tendenziell steigt oder sinkt, die Aktivitäten zwischen verschiedenen Konten zu vergleichen und zu entscheiden, wo Sie Ihre Bemühungen zur Kundenbindung oder Neukundengewinnung konzentrieren sollten.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** verschiedene Maßnahmen ergreifen, z. B. Ihre Aufmerksamkeit wieder auf diejenigen Konten richten, die weniger interagieren, aber aufgrund ihrer Bedeutung mehr Aufmerksamkeit erfordern.</p> |
