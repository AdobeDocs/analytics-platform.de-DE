...
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, wo Personen beim ersten Aufrufen der Site hingehen, welche Bereiche der Site von Personen am häufigsten besucht werden und welche Seiten Personen am wahrscheinlichsten von der Site wegführen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. bewerten, welche Pfade auf der Site Personen zu den wichtigsten Seiten führen und welche Seiten Personen wahrscheinlicher von der Site wegführen.<br/>Diese Vorlage verwendet die Dimension „Seite“ und die Metrik „Seitenansichten“, die Metrik „Besuche“, die Metrik „Unique Visitors“, die Metrik „Eintrittsrate“, die Metrik „Bounce-Rate“, die Metrik „Ausstiegsrate“ und die Metrik „Contentgeschwindigkeit“. Darüber hinaus werden Flussvisualisierungen für Eintritts-, Ausstiegs- und Top-Abschnitte verwendet. Eine Streuvisualisierung zeigt die Seitenansichten für die gängigsten Seiten an. Eine Balkenvisualisierung zeigt die Seitenansichten nach zusammengefasster Zeit an. Eine Linienvisualisierung zeigt eine Trend-Ansicht der durchschnittlichen Besuchszeit auf der Site an."
...
>title="Zeigen Sie Leistungsdaten zu In-App-Nachrichten und Push-Nachrichten für Ihre App an."
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, wie Personen In-App-Messaging-Funktionen verwenden und wie effektiv Push-Benachrichtigungen Traffic zu Ihrer App leiten.<br/>**Basierend auf Ihren Erkenntnissen können Sie** verschiedene Maßnahmen ergreifen, z. B. das Push-Benachrichtigungs-Erlebnis bei In-App-Nachrichten verbessern."
...
>title="Zeigen Sie an, welche Kundinnen und Kunden Ihrer App am treuesten sind und was sie in der App tun."
>abstract="**Dies kann Ihnen helfen**, zu verstehen, wie Ihre treuesten Kundinnen und Kunden Ihre App nutzen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Marketing-Aktionen für die Funktionen verbessern, die von Ihren treuesten Kundinnen und Kunden verwendet werden."
...
| **Beibehaltung von Mobile Apps** | Zeigen Sie an, welche Kundinnen und Kunden Ihrer App am treuesten sind und was sie in der App tun. <p>**Dies kann Ihnen helfen**, zu verstehen, wie Ihre treuesten Kundinnen und Kunden Ihre App nutzen.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Marketing-Aktionen für die Funktionen verbessern, die von Ihren treuesten Kundinnen und Kunden verwendet werden.</p><!-- This template uses the --> |
...
>title="Zeigen Sie an, wie Ihre Organisation Customer Journey Analytics verwendet. "
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, wie viele Personen in Ihrer Organisation Customer Journey Analytics wie oft verwenden und welche Nutzungs-Trends anhand dieser Daten im Zeitverlauf zu beobachten sind. Sie können auch die Anzahl der erstellten Projekte und Details zu diesen Projekten anzeigen. Erfahren Sie neben anderen Nutzungsstatistiken, welche Komponenten, Visualisierungen und Panels am häufigsten verwendet werden.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. nicht verwendete Projekte oder Komponenten löschen oder Benutzerschulungen für beliebte Funktionen bereitstellen."
...
| **Produktnutzungsübersicht** | Zeigen Sie an, wie Ihre Organisation Customer Journey Analytics verwendet. <p>**Dies kann Ihnen helfen**, besser zu verstehen, wie viele Personen in Ihrer Organisation Customer Journey Analytics wie oft verwenden und welche Nutzungs-Trends anhand dieser Daten im Zeitverlauf zu beobachten sind. Sie können auch die Anzahl der erstellten Projekte und Details zu diesen Projekten anzeigen. Erfahren Sie neben anderen Nutzungsstatistiken, welche Komponenten, Visualisierungen und Bedienfelder am häufigsten verwendet werden. [Weitere Informationen](/help/tools/product-usage/usage-overview.md)</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. nicht verwendete Projekte oder Komponenten löschen oder Benutzerschulungen für beliebte Funktionen bereitstellen.</p> |
