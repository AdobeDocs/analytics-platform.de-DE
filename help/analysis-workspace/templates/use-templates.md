...
>title="Zeigt die Geldmenge der bei allen Bestellungen gekauften Produkte an. Die Daten werden für einen bestimmten Zeitraum angezeigt und mit früheren Zeiträumen verglichen."
...
>title="Erfahren Sie, wer Ihre treuen Kunden sind und was sie auf Ihrer Site tun."
...
>abstract="**Dies kann Ihnen helfen**, besser zu verstehen, wo Personen beim ersten Aufrufen der Site hingehen, welche Bereiche der Site von Personen am häufigsten besucht werden und welche Seiten Personen am wahrscheinlichsten von der Site wegführen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. bewerten, welche Pfade auf der Site Personen zu den wichtigsten Seiten führen und welche Seiten Personen wahrscheinlicher von der Site wegführen.<br/>Diese Vorlage verwendet die Dimension „Seite“ und die Metrik „Seitenansichten“, die Metrik „Besuche“, die Metrik „Unique Visitors“, die Metrik „Eintrittsrate“, die Metrik „Bounce-Rate“, die Metrik „Ausstiegsrate“ und die Metrik „Contentgeschwindigkeit“. Darüber hinaus werden Flussvisualisierungen für die Eintritts-, Austritts- und oberen Abschnitte verwendet sowie eine Streudiagramm-Visualisierung, die Seitenansichten für die häufigsten Seiten anzeigt, eine Balkenvisualisierung, die Seitenansichten nach Zeitintervallen anzeigt, und eine Linienvisualisierung, die eine Trend-Ansicht der durchschnittlichen auf der Site verbrachten Zeit zeigt."
...
| **Übersicht über die Produktnutzung** | Sehen Sie sich an, wie Customer Journey Analytics in Ihrer Organisation verwendet wird. <p>**Auf diese Weise** Sie besser verstehen, wie viele Personen Customer Journey Analytics verwenden, wie oft sie es verwenden und welche Nutzungstrends im Laufe der Zeit zu beobachten sind. Sie können auch die Anzahl der erstellten Projekte und Details zu diesen Projekten (z. B. welche Komponenten, Visualisierungen und Panels am häufigsten verwendet werden) sowie viele andere Nutzungsstatistiken anzeigen.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. nicht verwendete Projekte oder Komponenten löschen oder Benutzerschulungen für beliebte Funktionen bereitstellen.</p> |
...
>abstract="**Dies kann Ihnen helfen**, die Keywords besser zu verstehen, die bei den Suchvorgängen verwendet werden, die zu Sitetraffic führen.<br/>**Basierend auf dem, was Sie lernen** können Sie eine beliebige Anzahl von Dingen tun, z. B. SEO-Lücken zwischen verwendeten Keywords und denen, die den Website-Traffic steuern, identifizieren und füllen. <br/>Diese Vorlage verwendet die Dimension „Suchbegriff – Paid“. "
...
>abstract="**Dies kann Ihnen helfen**, die Keywords besser zu verstehen, die bei Suchvorgängen verwendet werden, welche zu Sitetraffic führen.<br/>**Basierend auf dem, was Sie lernen** können Sie eine beliebige Anzahl von Dingen tun, z. B. SEO-Lücken zwischen verwendeten Keywords und denen, die den Website-Traffic steuern, identifizieren und füllen.<br/>Diese Vorlage verwendet die Dimension „Suchbegriff – Organisch“. "
...
>abstract="**Dies kann Ihnen dabei helfen,** verstehen, wie Menschen Ihre App verwenden und welchen Nutzen sie daraus ziehen.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. Funktionen entwickeln, die die beliebtesten Features ergänzen oder verbessern."
...
>abstract="**Dies kann Ihnen dabei helfen, besser** verstehen, wie viel Ihre App verwendet wird. <br/>**Basierend auf Ihren Erkenntnissen können Sie** verschiedene Maßnahmen ergreifen, z. B. die App-Leistung verbessern, damit sie entsprechend der Nutzungsintensität skaliert werden kann."
...
>abstract="**Dies kann Ihnen helfen,** verstehen, wie Personen Ihre App verwenden. <br/>**Basierend auf Ihren Erkenntnissen können Sie** verschiedene Maßnahmen ergreifen, z. B. die Art und Weise verbessern, wie die Benutzenden von einem Bildschirm zum anderen gelangen, um die gängigsten Workflows zu optimieren."
...
>abstract="**Auf diese Weise** Sie besser verstehen, wie Personen In-App-Messaging-Funktionen verwenden und wie effektiv Push-Benachrichtigungen den Traffic auf Ihre App lenken.<br/>**Basierend auf Ihren Erkenntnissen können Sie** verschiedene Maßnahmen ergreifen, z. B. das Push-Benachrichtigungs-Erlebnis bei In-App-Nachrichten verbessern."
...
>title="Erfahren Sie, welche Benutzer die treuesten Kunden Ihrer App sind und was sie in der App tun."
>abstract="**Auf diese Weise können Sie** verstehen, wie Ihre treuesten Kundinnen und Kunden Ihre App verwenden.<br/>**Je nachdem, was Sie lernen** können Sie beliebig viele Dinge tun, z. B. Ihre Marketing-Maßnahmen für die Funktionen verbessern, die Ihre treuesten Kundinnen und Kunden verwenden."
...
| **Nachrichten von Mobile Apps** | Zeigen Sie Leistungsdaten für In-App-Nachrichten und Push-Nachrichten für Ihre App an.<p>**Auf diese Weise** Sie besser verstehen, wie Personen In-App-Messaging-Funktionen verwenden und wie effektiv Push-Benachrichtigungen den Traffic auf Ihre App lenken.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** verschiedene Maßnahmen ergreifen, z. B. das Push-Benachrichtigungs-Erlebnis bei In-App-Nachrichten verbessern.</p><!-- This template uses the --> |
...
| **Beibehaltung von Mobile Apps** | Erfahren Sie, welche Benutzer die treuesten Kunden Ihrer App sind und was sie in der App tun. <p>**Auf diese Weise können Sie** verstehen, wie Ihre treuesten Kundinnen und Kunden Ihre App verwenden.</p><p>**Je nachdem, was Sie lernen** können Sie beliebig viele Dinge tun, z. B. Ihre Marketing-Maßnahmen für die Funktionen verbessern, die Ihre treuesten Kundinnen und Kunden verwenden.</p><!-- This template uses the --> |
...
>title="Erfahren Sie, wie Ihr Unternehmen Customer Journey Analytics verwendet."
>abstract="**Auf diese Weise können Sie** besser verstehen, wie viele Personen in Ihrem Unternehmen Customer Journey Analytics verwenden, wie oft sie es verwenden und wie sich diese Daten im Laufe der Zeit entwickeln. Sie können auch die Anzahl der erstellten Projekte und Details zu diesen Projekten anzeigen. Erfahren Sie neben anderen Nutzungsstatistiken, welche Komponenten, Visualisierungen und Bedienfelder am häufigsten verwendet werden.<br/>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. nicht verwendete Projekte oder Komponenten löschen oder Benutzerschulungen für beliebte Funktionen bereitstellen."
...
| **Übersicht über die Produktnutzung** | Erfahren Sie, wie Ihr Unternehmen Customer Journey Analytics verwendet.<p>**Auf diese Weise können Sie** besser verstehen, wie viele Personen in Ihrem Unternehmen Customer Journey Analytics verwenden, wie oft sie es verwenden und wie sich diese Daten im Laufe der Zeit entwickeln. Sie können auch die Anzahl der erstellten Projekte und Details zu diesen Projekten anzeigen. Erfahren Sie neben anderen Nutzungsstatistiken, welche Komponenten, Visualisierungen und Bedienfelder am häufigsten verwendet werden.</p><p>**Basierend auf Ihren Erkenntnissen können Sie** eine Reihe von Schritten ausführen, z. B. nicht verwendete Projekte oder Komponenten löschen oder Benutzerschulungen für beliebte Funktionen bereitstellen.</p> |
