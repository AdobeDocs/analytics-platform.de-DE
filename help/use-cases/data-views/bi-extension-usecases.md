...
* **Verbinden**
   * [Verbinden und Auflisten von Datenansichten](bi-extension/connect-and-validate.md)

* **Berichte und Analysen**
   * [Täglicher Trend](bi-extension/daily-trend.md)
   * [Stündlicher Trend](bi-extension/hourly-trend.md)
   * [Monatlicher Trend](bi-extension/monthly-trend.md)
   * [Rangfolge einzelner Dimensionen](bi-extension/single-dimension-ranked.md)
   * [Rangfolge mehrerer Dimensionen](bi-extension/multiple-dimension-ranked.md)
   * [Unterschiedliche Dimensionswerte zählen](bi-extension/count-distinct-dimension-values.md)
   * [Verwenden von Datumsbereichsnamen zum Filtern](bi-extension/use-date-range-names-to-filter.md)
   * [Segmentnamen zur Segmentierung verwenden](bi-extension/use-segment-names-to-segment.md)
   * [Segmentieren von Dimensionswerten](bi-extension/use-dimension-values-to-segment.md)
   * [Sortieren](bi-extension/sort.md)
   * [Beschränkungen](bi-extension/limits.md)

* **verstehen**

   * [Transformationen](bi-extension/transformations.md)
   * [Visualisierungen](bi-extension/visualizations.md)
   * [Einschränkungen](bi-extension/caveats.md)
...
Power BI Desktop supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/de/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
* [Credentials guide](https://experienceleague.adobe.com/de/docs/experience-platform/query/ui/credentials)
* [Connect Power BI to Query Service](https://experienceleague.adobe.com/de/docs/experience-platform/query/clients/power-bi).
...
Tableau Desktop supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/de/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
* [Prerequisites](/help/data-views/bi-extension.md#prerequisites)
* [Credentials guide](https://experienceleague.adobe.com/de/docs/experience-platform/query/ui/credentials)
* [Connect Tableau Desktop to Query Service](https://experienceleague.adobe.com/de/docs/experience-platform/query/clients/tableau).
...
Looker supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/de/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
Jupyter Notebook supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/de/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
RStudio supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/de/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
