...
Nachdem Sie die gewünschten Tags implementiert und auf Ihrer Site veröffentlicht haben, können Sie mit [Erstellen einer Verbindung](/help/connections/create-connection.md) und dann mit [Erstellen einer Datenansicht](/help/data-views/create-dataview.md) fortfahren.
