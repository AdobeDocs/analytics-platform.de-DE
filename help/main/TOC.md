...
+ Versionshinweise  {#releases}
   + [Neueste Customer Journey Analytics-Version](../release-notes/latest.md)
   + [Hinweise zu Vorabversionen von Customer Journey Analytics](../release-notes/pre-release-notes.md)
