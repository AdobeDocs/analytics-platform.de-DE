...
+ Versionshinweise {#releases}
  ...
  + {hide-from-toc}[Vorab veröffentlichte Versionshinweise](../release-notes/pre-release-notes.md)
...
+ Aktualisieren und Vergleichen {#compare-aa-cja}
  + Upgrade auf Customer Journey Analytics {#upgrade-to-cja}
    + {hide-from-toc}[Erste Schritte](/help/getting-started/cja-upgrade/cja-upgrade-getstarted.md)
    + {hide-from-toc}[Wählen Sie Ihren Aktualisierungspfad](/help/getting-started/cja-upgrade/cja-upgrade-path.md)
    + {hide-from-toc}[Senden von Daten an Platform](/help/getting-started/cja-upgrade/cja-upgrade-send-to-platform.md)
  ...
  + Wechsel von Google Analytics 4 {#ga-to-cja}
    ...
    + [Berichtäquivalente](/help/getting-started/ga-to-cja/reports.md)
    + [Datenunterschiede](/help/getting-started/ga-to-cja/compare-data.md)
...
+ Datenspiegelung {#cja-data-mirror}
  ...
  + [Zu beachten](/help/data-mirror/considerations.md)
...
+ Datenansichten {#cja-dataviews}
  ...
  + Komponenteneinstellungen {#component-settings}
    ...
    + {hide-from-toc}[Anwendungsbereich](/help/data-views/component-settings/scope.md)
...
+ Workspace-Projekte {#cja-workspace}
  ...
  + Visualisierungen {#visualizations}
    ...
    + Freiformtabelle {#freeform-table}
      ...
      + [Mehrere Dimensionen einbeziehen](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)
  ...
  + Kuratieren und Freigeben {#curate-share}
    ...
    + [Generieren von Folienpräsentationen](/help/analysis-workspace/curate-share/generate-slides.md)
  + Exportieren {#export}
...
+ Konversationseinblicke {#conversation-insights}
  + {hide-from-toc}[Überblick](/help/conversatiion-insights/conversation-insights.md)
  + {hide-from-toc}[Konfiguration](/help/conversatiion-insights/config/guided.md)
...
+ Komponenten {#cja-components}
  ...
  + Zielgruppenveröffentlichung {#audiences}
    + [Überblick über die Zielgruppenveröffentlichung](../components/audiences/audiences-overview.md)
    + [Erstellen und Veröffentlichen von Zielgruppen](../components/audiences/publish.md)
    + [Verwalten veröffentlichter Zielgruppen](../components/audiences/manage.md)
  ...
  + Segmente {#segments}
    ...
    + [Analyse der Unterereignisse](/help/components/segments/sub-event.md)
...
+ Zuordnung {#stitching}
  ...
  + B2B {#b2b}
    + {hide-from-toc}[Zuordnung von Person zu Konto](/help/stitching/b2b/b2b-person-to-account-stitching.md)

+ Berichte zur Gesamtpopulation {#tpr}
  + {hide-from-toc}[Überblick](/help/tpr/tpr.md)
  + {hide-from-toc}[Freigegebene Suchen](/help/tpr/shared-lookups.md)
