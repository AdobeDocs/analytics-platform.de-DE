...
>[!IMPORTANT]
>
>In diesem Artikel wird beschrieben, wie Sie Zusammenfügungen überprüfen[&#x200B; die (über Adobe angefordert](/help/stitching/use-stitching.md) und mithilfe einer zusammengefügten Identitätsspalte implementiert werden, die einem doppelten zusammengefügten Datensatz hinzugefügt wird. Der Artikel soll bald mit Details zum Validieren von Zuordnungen aktualisiert werden, die (über [&#x200B; Verbindungsbenutzeroberfläche) aktiviert &#x200B;](/help/stitching/use-stitching-ui.md).
