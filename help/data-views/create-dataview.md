...
1. Suchen Sie nach einem Schemafeld mit ![Suchsymbol](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Search_18_N.svg) **[!UICONTROL Suchschemafeldern]** oder suchen Sie ein Feld, indem Sie in eine der Datensatzsammlungen wechseln, z. B. ![Ordner](/help/assets/icons/Folder.svg) **[!UICONTROL Ereignisdatensätze]** oder ![Ordner](/help/assets/icons/Folder.svg) **[!UICONTROL Lookup-Datensätze]**. Für Ereignisdatensätze sind separate Sammlungen für ![Ordner](/help/assets/icons/Folder.svg) **[!UICONTROL XDM-Felder]** und ![Ordner](/help/assets/icons/Folder.svg) **[!UICONTROL Ad-hoc- und relationale Felder]** verfügbar.<br/>Alternativ können Sie über ![Datensymbol](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Data_18_N.svg) **Abgeleitetes Feld erstellen** ein abgeleitetes Feld erstellen. Weitere Informationen finden Sie unter [Abgeleitete Felder](./derived-fields/derived-fields.md).
...
Unter **[!UICONTROL Enthaltene Komponenten]** sind die **[!UICONTROL Metriken]** und **[!UICONTROL Dimensionen]** aufgelistet, die Sie für die Datenansicht konfigurieren.
...
* Um die aufgelisteten enthaltenen Komponenten zu filtern, wählen Sie ![Filtern](/help/assets/icons/Filter.svg) aus.
   ...
   * **[!UICONTROL Data Governance]** – Wählen Sie eine oder mehrere Labels aus den Unterkategorien [!UICONTROL Benutzerdefinierte Labels], [!UICONTROL Labels für Verträge], [!UICONTROL Identitäts-Labels], [!UICONTROL Sensibilitäts-Labels], [!UICONTROL Partner-Ökosystem] oder [!UICONTROL Richtlinien] aus.
