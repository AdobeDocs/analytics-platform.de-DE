...
1. Wählen Sie die `cja`-Datenbank für Ihre Sandbox aus der Liste der Datenbanken im Dropdown-Menü **[!UICONTROL Datenbank]** aus. Zum Beispiel `prod:cja`.
...
Filtern, 
und Aggregation </td>
            <td>Ebenenweise mithilfe von Unterauswahlen:
