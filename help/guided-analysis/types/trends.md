...
# Ansicht [!UICONTROL Trends]

Die Ansicht ![GraphTrend](/help/assets/icons/GraphTrend.svg) **[!UICONTROL Trends]** bietet wertvolle Einblicke in die Leistung Ihres Produkts oder das Verhalten Ihrer Benutzer im Zeitverlauf. Die horizontale Achse dieses Berichts ist ein Zeitintervall, während die vertikale Achse Ihre gewünschten Ereignisse misst.
...
* **[!UICONTROL Ansicht]**: Zwischen diesem Ansichtstyp und [Häufigkeit](frequency.md) wechseln.
...
Die Ansicht [!UICONTROL Nutzung] bietet die folgenden Diagrammeinstellungen, die im Menü über dem Diagramm angepasst werden können:
...
![Nutzungszeitvergleich](../assets/usage-compare.png){style="border:1px solid gray"}
